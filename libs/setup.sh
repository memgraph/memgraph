...
declare -A primary_urls=(
  ["antlr4-code"]="http://$local_cache_host/git/antlr4"
  ["antlr4-generator"]="http://$local_cache_host/file/antlr-4.6-complete.jar"
  ["cppitertools"]="http://$local_cache_host/git/cppitertools"
  ["fmt"]="http://$local_cache_host/git/fmt"
  ["rapidcheck"]="http://$local_cache_host/git/rapidcheck"
  ["gbenchmark"]="http://$local_cache_host/git/benchmark"
  ["gtest"]="http://$local_cache_host/git/googletest"
  ["gflags"]="http://$local_cache_host/git/gflags"
  ["libbcrypt"]="http://$local_cache_host/git/libbcrypt"
  ["bzip2"]="http://$local_cache_host/git/bzip2"
  ["zlib"]="http://$local_cache_host/git/zlib"
  ["rocksdb"]="http://$local_cache_host/git/rocksdb"
  ["mgclient"]="http://$local_cache_host/git/mgclient"
  ["pymgclient"]="http://$local_cache_host/git/pymgclient"
  ["spdlog"]="http://$local_cache_host/git/spdlog"
  ["jemalloc"]="http://$local_cache_host/git/jemalloc"
