...
def main():
    ...
    load(args, ids)
    print(f"loaded {VERTICES} Node/Value pairs; {BATCHES} disjoint batches of {BATCH_SIZE} rows per trial")
    print(f"{'writers':>7}  {'wall_s':>7}  {'server_cpu_s':>12}  {'tx_p50_ms':>9}   (medians of {TRIALS} trials)")
    for writers in WRITER_COUNTS:
        ...
        print(f"{writers:>7}  {wall:>7.2f}  {cpu:>12.2f}  {p50:>9.1f}")
