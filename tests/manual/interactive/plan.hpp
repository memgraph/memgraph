...
inline query::Query *MakeAst(const std::string &query, query::AstStorage *storage) {
...
// cost.
inline auto MakeLogicalPlans(query::CypherQuery *query, query::AstStorage &ast, query::SymbolTable &symbol_table,
