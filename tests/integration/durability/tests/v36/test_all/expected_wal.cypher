...
CREATE (:__mg_vertex__:`TTL` {__mg_id__: 13, `ttl`: 4102444800000000});
...
CREATE (:__mg_vertex__:`desc_label` {__mg_id__: 16, `prop`: 42});
CREATE (:__mg_vertex__:`desc_composite` {__mg_id__: 17, `a`: 10, `b`: 20});
CREATE (:__mg_vertex__:`LabelA` {__mg_id__: 18, `or_embedding`: [1, 2]});
CREATE (:__mg_vertex__:`LabelB` {__mg_id__: 19, `or_embedding`: [3, 4]});
CREATE (:__mg_vertex__:`LabelD`:`LabelC` {__mg_id__: 20, `and_embedding`: [5, 6]});
CREATE (:__mg_vertex__:`LabelE` {__mg_id__: 21, `wild_embedding`: [7, 8]});
CREATE (:__mg_vertex__ {__mg_id__: 22});
CREATE (:__mg_vertex__ {__mg_id__: 23});
CREATE (:__mg_vertex__ {__mg_id__: 24});
CREATE (:__mg_vertex__ {__mg_id__: 25});
CREATE (:__mg_vertex__ {__mg_id__: 26});
CREATE (:__mg_vertex__ {__mg_id__: 27});
CREATE (:__mg_vertex__ {__mg_id__: 28});
CREATE (:__mg_vertex__ {__mg_id__: 29});
CREATE (:__mg_vertex__ {__mg_id__: 30});
CREATE (:__mg_vertex__ {__mg_id__: 31});
...
MATCH (u:__mg_vertex__), (v:__mg_vertex__) WHERE u.__mg_id__ = 8 AND v.__mg_id__ = 9 CREATE (u)-[:`edge_type` {`ttl`: 4102444800000000}]->(v);
MATCH (u:__mg_vertex__), (v:__mg_vertex__) WHERE u.__mg_id__ = 22 AND v.__mg_id__ = 23 CREATE (u)-[:`REL` {`embedding`: [1, 2, 3]}]->(v);
MATCH (u:__mg_vertex__), (v:__mg_vertex__) WHERE u.__mg_id__ = 24 AND v.__mg_id__ = 25 CREATE (u)-[:`ER1` {`or_embedding`: [11, 12]}]->(v);
MATCH (u:__mg_vertex__), (v:__mg_vertex__) WHERE u.__mg_id__ = 26 AND v.__mg_id__ = 27 CREATE (u)-[:`ER2` {`or_embedding`: [13, 14]}]->(v);
MATCH (u:__mg_vertex__), (v:__mg_vertex__) WHERE u.__mg_id__ = 28 AND v.__mg_id__ = 29 CREATE (u)-[:`WILD_REL` {`wild_embedding`: [15, 16]}]->(v);
MATCH (u:__mg_vertex__), (v:__mg_vertex__) WHERE u.__mg_id__ = 30 AND v.__mg_id__ = 31 CREATE (u)-[:`TEXT_REL` {`prop2`: "second text", `prop1`: "first text", `prop3`: "third text"}]->(v);
...
CREATE VECTOR INDEX `vector_index_wildcard` ON (`wild_embedding`) WITH CONFIG { "dimension": 2, "metric": "l2sq", "capacity": 10, "resize_coefficient": 2, "scalar_kind": "f32" };
CREATE VECTOR INDEX `vector_index_and` ON :`LabelC`&`LabelD`(`and_embedding`) WITH CONFIG { "dimension": 2, "metric": "l2sq", "capacity": 10, "resize_coefficient": 2, "scalar_kind": "f32" };
CREATE VECTOR INDEX `vector_index_or` ON :`LabelA`|`LabelB`(`or_embedding`) WITH CONFIG { "dimension": 2, "metric": "l2sq", "capacity": 10, "resize_coefficient": 2, "scalar_kind": "f32" };
