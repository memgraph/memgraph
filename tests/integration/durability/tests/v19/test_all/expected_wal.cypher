...
CREATE (:__mg_vertex__:`label2` {__mg_id__: 6, `coord wgs-84 2d`: POINT({ x:-73.93, y:40.73, srid: 4326 }), `coord wgs-84 3d`: POINT({ x:-73.93, y:40.73, z:10, srid: 4979 }), `coord Cartesian 2d`: POINT({ x:0, y:1, srid: 7203 }), `coord Cartesian 3d`: POINT({ x:0, y:1, z:2, srid: 9157 })});
