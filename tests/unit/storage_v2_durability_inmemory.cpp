...
TEST_P(DurabilityTest, ConstraintsRecoveryFunctionSetting) {
  ...
  memgraph::storage::Indices indices{config, memgraph::storage::StorageMode::IN_MEMORY_TRANSACTIONAL, nullptr};
  memgraph::storage::Constraints constraints{config, memgraph::storage::StorageMode::IN_MEMORY_TRANSACTIONAL, nullptr};
  memgraph::storage::ReplicationStorageState repl_storage_state;
  memgraph::storage::EnumStore enum_store;
  memgraph::storage::ttl::TTL ttl{nullptr, nullptr};
