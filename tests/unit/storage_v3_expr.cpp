...
// //   AstStorage storage;
// //   auto *ident_x = IDENT("x");
// //   auto *all = ALL("x", LIST(LITERAL(1), LITERAL(memgraph::storage::PropertyValue())), WHERE(EQ(ident_x,
// //   LITERAL(1)))); const auto x_sym = symbol_table.CreateSymbol("x", true); all->identifier_->MapTo(x_sym);
// //   ident_x->MapTo(x_sym);
// //   auto value = Eval(all);
// //   ASSERT_TRUE(value.IsBool());
// //   EXPECT_FALSE(value.ValueBool());
...
// //   AstStorage storage;
// //   auto *ident_x = IDENT("x");
// //   auto *all = ALL("x", LIST(LITERAL(2), LITERAL(memgraph::storage::PropertyValue())), WHERE(EQ(ident_x,
// //   LITERAL(1)))); const auto x_sym = symbol_table.CreateSymbol("x", true); all->identifier_->MapTo(x_sym);
// //   ident_x->MapTo(x_sym);
// //   auto value = Eval(all);
// //   ASSERT_TRUE(value.IsBool());
...
// //   AstStorage storage;
// //   auto *ident_x = IDENT("x");
// //   auto *any = ANY("x", LIST(LITERAL(0), LITERAL(memgraph::storage::PropertyValue())), WHERE(EQ(ident_x,
// //   LITERAL(0)))); const auto x_sym = symbol_table.CreateSymbol("x", true); any->identifier_->MapTo(x_sym);
// //   ident_x->MapTo(x_sym);
// //   auto value = Eval(any);
// //   EXPECT_TRUE(value.ValueBool());
// // }
...
// //   AstStorage storage;
// //   auto *ident_x = IDENT("x");
// //   auto *any = ANY("x", LIST(LITERAL(1), LITERAL(memgraph::storage::PropertyValue())), WHERE(EQ(ident_x,
// //   LITERAL(0)))); const auto x_sym = symbol_table.CreateSymbol("x", true); any->identifier_->MapTo(x_sym);
// //   ident_x->MapTo(x_sym);
// //   auto value = Eval(any);
// //   EXPECT_FALSE(value.ValueBool());
...
// //   AstStorage storage;
// //   auto *ident_x = IDENT("x");
// //   auto *any = NONE("x", LIST(LITERAL(1), LITERAL(memgraph::storage::PropertyValue())), WHERE(EQ(ident_x,
// //   LITERAL(0)))); const auto x_sym = symbol_table.CreateSymbol("x", true); any->identifier_->MapTo(x_sym);
// //   ident_x->MapTo(x_sym);
// //   auto value = Eval(any);
// //   EXPECT_TRUE(value.ValueBool());
...
// //   AstStorage storage;
// //   auto *ident_x = IDENT("x");
// //   auto *none = NONE("x", LIST(LITERAL(0), LITERAL(memgraph::storage::PropertyValue())), WHERE(EQ(ident_x,
// //   LITERAL(0)))); const auto x_sym = symbol_table.CreateSymbol("x", true); none->identifier_->MapTo(x_sym);
// //   ident_x->MapTo(x_sym);
// //   auto value = Eval(none);
// //   EXPECT_FALSE(value.ValueBool());
// // }
...
// //   auto *ident_x = IDENT("x");
// //   auto *extract =
// //       EXTRACT("x", LIST(LITERAL(1), LITERAL(2), LITERAL(memgraph::storage::PropertyValue())), ADD(ident_x,
// //       LITERAL(1)));
// //   const auto x_sym = symbol_table.CreateSymbol("x", true);
...
// //   EXPECT_EQ(Eval(COALESCE(LITERAL(TypedValue()), LITERAL(2), FN("ASSERT", LITERAL(false)),
// LITERAL(3))).ValueInt(),
// //   2);
...
//   ASSERT_TRUE(
//       *EvaluateFunction("ENDNODE", *e).ValueVertex().HasLabel(memgraph::storage::View::NEW,
...
// TEST_F(FunctionTest, ToStringExceptions) { EXPECT_THROW(EvaluateFunction("TOSTRING", 1, 2, 3),
...
//       TypedValue(1970)}})), QueryRuntimeException);
// }
