...
// //   ASSERT_EQ(
// //       EvaluateFunction("VALUETYPE", TypedValue(std::vector<TypedValue>{TypedValue(1),
// TypedValue(2)})).ValueString(),
// //       "LIST");
...
// //   ASSERT_THROW(EvaluateFunction("UNIFORMSAMPLE", MakeTypedValueList(1, 2, 3), -1),
// expr::ExpressionRuntimeException);
...
// //   EXPECT_EQ(EvaluateFunction("LOCALTIME", map_param).ValueLocalTime(), memgraph::utils::LocalTime({1, 2, 3, 4,
// 5}));
...
// //   EXPECT_THROW(
// //       EvaluateFunction("LOCALDATETIME", TypedValue(std::map<std::string, TypedValue>{{"hours",
// TypedValue(1970)}})),
// //       expr::ExpressionRuntimeException);
// //   EXPECT_THROW(
...
// //   EXPECT_EQ(EvaluateFunction("DURATION", map_param).ValueDuration(), memgraph::utils::Duration({3, 4, 5, 6, 7,
// 8}));
