...
// A failure here presents as the test not finishing. That is the honest shape for a deadlock, and
// the unit-test timeout turns it into a named failure with a core rather than an unattributed
// cancellation.
