...
TEST_F(TriggerContextTest, ValidObjectsTest) {
  ...
  size_t deleted_edge_count = 0;
  {
    ...
    check_label_map(query::trigger::IdentifierTag::SET_VERTEX_LABELS, vertex_count, dba);
    check_label_map(query::trigger::IdentifierTag::REMOVED_VERTEX_LABELS, vertex_count, dba);
