...
class HighAvailabilityClusterSetupTest : public ::testing::Test {
 ...
 protected:
  ...
  CoordinatorInstance coordinator1{
      CoordinatorInstanceInitConfig{1, 10111, 7690, storage_directories[0] / "high_availability"}};
  CoordinatorInstance coordinator2{
      CoordinatorInstanceInitConfig{2, 10112, 7691, storage_directories[1] / "high_availability"}};
  CoordinatorInstance coordinator3{
      CoordinatorInstanceInitConfig{3, 10113, 7692, storage_directories[2] / "high_availability"}};
