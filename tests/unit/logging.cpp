...
// A connection-reuse boundary (RESET/LogOff) must clear the SET SESSION TRACE/SETTING overlay so it
// doesn't leak into the next pooled session, while preserving connection identity and auth user.
