...
TEST_F(RecoverSnapshotTest, RecoverSnapshotCreatesOldDirectory) {
  ...
  ASSERT_FALSE(!snapshot_result2.has_value());
  ...
  ASSERT_FALSE(!recover_result.has_value()) << "RecoverSnapshot should succeed";
  ...
  ASSERT_FALSE(!recover2_result.has_value()) << "RecoverSnapshot should succeed";
