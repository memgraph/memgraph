...
TEST_F(DBMS_Database, Get) {
  ...
  auto db1 = db_handler.New(default_conf("db1"));
  auto db2 = db_handler.New(default_conf("db2"));
  auto db3 = db_handler.New(default_conf("db3"));
