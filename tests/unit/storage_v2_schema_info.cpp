...
TYPED_TEST(SchemaInfoTest, MultipleEdges) {
  ...
  // create multiple edges
  {
    ...
    ASSERT_EQ(json["edges"].size(), 3);
    ASSERT_EQ(json["edges"][0]["type"], "E2");
    ASSERT_EQ(json["edges"][0]["start_node_labels"], nlohmann::json::array({/* empty */}));
    ASSERT_EQ(json["edges"][0]["end_node_labels"], nlohmann::json::array({/* empty */}));
    ASSERT_EQ(json["edges"][0]["count"], 1);
    ASSERT_EQ(json["edges"][0]["properties"].size(), 0);
    ASSERT_EQ(json["edges"][1]["type"], "E");
    ASSERT_EQ(json["edges"][1]["start_node_labels"], nlohmann::json::array({/* empty */}));
    ASSERT_EQ(json["edges"][1]["end_node_labels"], nlohmann::json::array({/* empty */}));
    ASSERT_EQ(json["edges"][1]["count"], 1);
    ASSERT_EQ(json["edges"][1]["properties"].size(), 0);
    ASSERT_EQ(json["edges"][2]["type"], "E3");
    ASSERT_EQ(json["edges"][2]["start_node_labels"], nlohmann::json::array({/* empty */}));
    ASSERT_EQ(json["edges"][2]["end_node_labels"], nlohmann::json::array({/* empty */}));
    ASSERT_EQ(json["edges"][2]["count"], 1);
    ASSERT_EQ(json["edges"][2]["properties"].size(), 0);
  }
  ...
  // delete edge
  {
    ...
    ASSERT_EQ(json["edges"][0]["count"], 1);
    ASSERT_EQ(json["edges"][0]["properties"].size(), 0);
    ASSERT_EQ(json["edges"][1]["type"], "E3");
    ASSERT_EQ(json["edges"][1]["start_node_labels"], nlohmann::json::array({/* empty */}));
    ASSERT_EQ(json["edges"][1]["end_node_labels"], nlohmann::json::array({/* empty */}));
    ASSERT_EQ(json["edges"][1]["count"], 1);
    ASSERT_EQ(json["edges"][1]["properties"].size(), 0);
  ...
  // change vertex label
  {
    ...
    ASSERT_EQ(json["edges"][0]["type"], "E2");
    ASSERT_EQ(json["edges"][0]["start_node_labels"], nlohmann::json::array({/* empty */}));
    ASSERT_EQ(json["edges"][0]["end_node_labels"], nlohmann::json::array({"L1"}));
    ASSERT_EQ(json["edges"][0]["count"], 1);
    ASSERT_EQ(json["edges"][0]["properties"].size(), 0);
    ASSERT_EQ(json["edges"][1]["type"], "E3");
    ASSERT_EQ(json["edges"][1]["start_node_labels"], nlohmann::json::array({"L1"}));
    ASSERT_EQ(json["edges"][1]["end_node_labels"], nlohmann::json::array({/* empty */}));
    ASSERT_EQ(json["edges"][1]["count"], 1);
    ASSERT_EQ(json["edges"][1]["properties"].size(), 0);
  }
  ...
  // create multiple edges
  {
    ...
    ASSERT_EQ(json["edges"][0]["properties"].size(), 0);
    ASSERT_EQ(json["edges"][1]["type"], "E3");
    ASSERT_EQ(json["edges"][1]["start_node_labels"], nlohmann::json::array({"L2", "L3"}));
    ASSERT_EQ(json["edges"][1]["end_node_labels"], nlohmann::json::array({"L1", "L2"}));
    ASSERT_EQ(json["edges"][1]["count"], 1);
    ASSERT_EQ(json["edges"][1]["properties"].size(), 0);
    ASSERT_EQ(json["edges"][2]["type"], "E");
    ASSERT_EQ(json["edges"][2]["start_node_labels"], nlohmann::json::array({"L2", "L3"}));
    ASSERT_EQ(json["edges"][2]["end_node_labels"], nlohmann::json::array({"L1", "L2"}));
    ASSERT_EQ(json["edges"][2]["count"], 2);
    ASSERT_EQ(json["edges"][2]["properties"].size(), 0);
    ASSERT_EQ(json["edges"][3]["type"], "E2");
    ASSERT_EQ(json["edges"][3]["start_node_labels"], nlohmann::json::array({/* empty */}));
    ASSERT_EQ(json["edges"][3]["end_node_labels"], nlohmann::json::array({"L1"}));
    ASSERT_EQ(json["edges"][3]["count"], 1);
    ASSERT_EQ(json["edges"][3]["properties"].size(), 0);
    ASSERT_EQ(json["edges"][4]["type"], "E3");
    ASSERT_EQ(json["edges"][4]["start_node_labels"], nlohmann::json::array({"L1"}));
    ASSERT_EQ(json["edges"][4]["end_node_labels"], nlohmann::json::array({/* empty */}));
    ASSERT_EQ(json["edges"][4]["count"], 1);
    ASSERT_EQ(json["edges"][4]["properties"].size(), 0);
  }
...
TYPED_TEST(SchemaInfoTestWEdgeProp, SingleEdge) {
  ...
  // add edge properties
  {
    ...
    ASSERT_EQ(json["edges"][0]["end_node_labels"], nlohmann::json::array({/* empty */}));
    ASSERT_EQ(json["edges"][0]["count"], 1);
    ASSERT_EQ(json["edges"][0]["properties"].size(), 2);
    ...
    ASSERT_EQ(json["edges"][0]["properties"][0]["types"][0]["type"], "int");
    ASSERT_EQ(json["edges"][0]["properties"][0]["types"][0]["count"], 1);
    ASSERT_EQ(json["edges"][0]["properties"][1]["key"], "p2");
    ASSERT_EQ(json["edges"][0]["properties"][1]["count"], 1);
    ASSERT_EQ(json["edges"][0]["properties"][1]["types"].size(), 1);
    ASSERT_EQ(json["edges"][0]["properties"][1]["types"][0]["type"], "string");
    ASSERT_EQ(json["edges"][0]["properties"][1]["types"][0]["count"], 1);
  }
  ...
  // change from label
  {
    ...
    ASSERT_EQ(json["edges"][0]["count"], 1);
    ASSERT_EQ(json["edges"][0]["properties"].size(), 2);
    ASSERT_EQ(json["edges"][0]["properties"][1]["key"], "p1");
    ASSERT_EQ(json["edges"][0]["properties"][1]["count"], 1);
    ASSERT_EQ(json["edges"][0]["properties"][1]["types"].size(), 1);
    ASSERT_EQ(json["edges"][0]["properties"][1]["types"][0]["type"], "int");
    ASSERT_EQ(json["edges"][0]["properties"][1]["types"][0]["count"], 1);
    ASSERT_EQ(json["edges"][0]["properties"][0]["key"], "p2");
    ASSERT_EQ(json["edges"][0]["properties"][0]["count"], 1);
    ASSERT_EQ(json["edges"][0]["properties"][0]["types"].size(), 1);
