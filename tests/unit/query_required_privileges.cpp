...
TEST_F(TestPrivilegeExtractor, AuthQuery) {
  auto label_privileges = std::vector<std::unordered_map<AuthQuery::EntityPrivilege, std::vector<std::string>>>{};
  auto edge_type_privileges = std::vector<std::unordered_map<AuthQuery::EntityPrivilege, std::vector<std::string>>>{};
