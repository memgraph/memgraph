...
TEST(LabelRankT, DisconnectedGraph) {
  ...
  std::unordered_map<std::uint64_t, std::int64_t> correct_labels = {{0, 1},
                                                                    {1, 1},
                                                                    {2, 1},
                                                                    {3, 1},
                                                                    {4, 2},
...
TEST(LabelRankT, UpdateLabelsEdgesChanged) {
  ...
  labels = algorithm.UpdateLabels(
      std::move(updated_graph), {}, {{0, 13}, {3, 9}, {10, 12}}, {}, {{9, 12}, {9, 14}, {10, 13}});
...
TEST(LabelRankT, UpdateLabelsNodesChanged) {
  ...
  updated_graph = mg_generate::BuildGraph(
      16,
      {{0, 1},   {0, 2},   {0, 3},   {0, 13},  {1, 2},   {1, 4},   {1, 7},   {2, 3},  {2, 4},  {2, 6},  {2, 9},
...
TEST(LabelRankT, WeightedGraph) {
  auto weighted_graph = mg_generate::BuildWeightedGraph(
      6,
      {{{0, 1}, 1}, {{0, 2}, 1}, {{1, 2}, 1}, {{2, 3}, 2}, {{3, 4}, 1}, {{3, 5}, 1}, {{4, 5}, 1}},
