...
TEST(String, DoubleToString) {
  ...
  EXPECT_EQ(DoubleToString(1.01234567890123456789), "1.01234567890123");
  EXPECT_EQ(DoubleToString(1234567.01234567891234567), "1234567.01234567");
  EXPECT_EQ(DoubleToString(0.00001), "0.00001");
  EXPECT_EQ(DoubleToString(0.00000000000001), "0.00000000000001");
  EXPECT_EQ(DoubleToString(0.000000000000001), "0");
}
