...
// ============================================================================
// EDGE PROPERTY INDEX CHUNKING TESTS
// ============================================================================

class EdgePropertyIndexChunkingTest : public ::testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(EdgePropertyIndexChunkingTest, BasicEdgePropertyIndexChunking) {
...
TEST_F(EdgePropertyIndexChunkingTest, EdgePropertyIndexChunkingWithRange) {
...
TEST_F(EdgePropertyIndexChunkingTest, EdgePropertyIndexChunkingWithLowerBound) {
...
TEST_F(EdgePropertyIndexChunkingTest, EdgePropertyIndexChunkingWithUpperBound) {
  // Create edges with property values
  std::vector<Gid> edge_gids;
  {
    auto acc = storage_->Access();
...
TEST_F(EdgePropertyIndexChunkingTest, EdgePropertyIndexChunkingEdgeCases) {
  // Create edges with property values
  std::vector<Gid> edge_gids;
  {
    auto acc = storage_->Access();
...
TEST_F(EdgePropertyIndexChunkingTest, EdgePropertyIndexChunkingBigDataset) {
  // Create edges with property values
  std::vector<Gid> edge_gids;
  {
    auto acc = storage_->Access();
...

  {
    auto locked_gids = read_gids.Lock();
    std::sort(locked_gids->begin(), locked_gids->end());
    ASSERT_EQ(total_count.load(), 60'001);
    ASSERT_EQ(locked_gids->size(), 60'001);
  }
}

TEST_F(EdgePropertyIndexChunkingTest, EdgePropertyIndexChunkingConcurrentOperations) {
...
TEST_F(EdgePropertyIndexChunkingTest, EdgePropertyIndexChunkingMultipleEntries) {
...
TEST_F(EdgePropertyIndexChunkingTest, EdgePropertyIndexChunkingDynamic) {
  // Create edges with specific property values
  std::vector<Gid> edge_gids;
  std::vector<Gid> property_edge_gids;
...
TEST_F(EdgePropertyIndexChunkingTest, EdgePropertyIndexChunkingManyEntries) {
  // Create edges with specific property values
  std::vector<Gid> edge_gids;
  std::vector<Gid> property_edge_gids;
...
TEST_F(EdgePropertyIndexChunkingTest, EdgePropertyIndexChunkingComprehensiveEdgeCases) {
  // Create edges with specific property values
  std::vector<Gid> edge_gids;
  std::vector<Gid> property_edge_gids;
...
TEST_F(EdgePropertyIndexChunkingTest, EdgePropertyIndexChunkingBasicRange) {
  // Create edges with specific property values
  std::vector<Gid> edge_gids;
  std::vector<Gid> property_edge_gids;
