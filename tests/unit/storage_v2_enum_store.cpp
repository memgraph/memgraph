...
TEST(EnumStore, BasicTests) {
  ...
  ASSERT_FALSE(sut.AddValue("Location", "London").has_value());
  ASSERT_FALSE(sut.UpdateValue("Location", "London", "London").has_value());
  ASSERT_FALSE(sut.UpdateValue("Location", "London", "York").has_value());
  {
