...
print_help() {
  ...
  echo -e ""
  echo -e "  One process runs the workloads that manage their own Memgraph instances one at a time,"
  echo -e "  the remaining processes run the workloads.yaml clusters in parallel on remapped ports."
  echo -e ""
  echo -e "  Examples:"
