...
def test_weighted_shortest_path_all_edge_types_all_labels_granted(switch):
    ...
    try:
        ...
        common.execute_and_fetch_all(admin_connection.cursor(), "REVOKE READ ON NODES CONTAINING LABELS * FROM user;")
        common.execute_and_fetch_all(admin_connection.cursor(), "REVOKE READ ON EDGES CONTAINING TYPES * FROM user;")
...
def test_weighted_shortest_path_all_edge_types_all_labels_denied(switch):
    ...
    try:
        ...
        common.execute_and_fetch_all(
            admin_connection.cursor(), "REVOKE NOTHING ON NODES CONTAINING LABELS * FROM user;"
        )
        common.execute_and_fetch_all(admin_connection.cursor(), "REVOKE NOTHING ON EDGES CONTAINING TYPES * FROM user;")
...
def test_weighted_shortest_path_denied_start(switch):
    ...
    try:
        ...
        common.execute_and_fetch_all(
            ...
            "REVOKE READ ON NODES CONTAINING LABELS :label1, :label2, :label3, :label4 FROM user;",
        )
        common.execute_and_fetch_all(admin_connection.cursor(), "REVOKE READ ON EDGES CONTAINING TYPES * FROM user;")
        common.execute_and_fetch_all(
            admin_connection.cursor(), "REVOKE NOTHING ON NODES CONTAINING LABELS :label0 FROM user;"
        )
...
def test_weighted_shortest_path_denied_destination(switch):
    ...
    try:
        ...
        common.execute_and_fetch_all(
            admin_connection.cursor(),
            "REVOKE READ ON NODES CONTAINING LABELS :label0, :label1, :label2, :label3 FROM user;",
        )
        common.execute_and_fetch_all(admin_connection.cursor(), "REVOKE READ ON EDGES CONTAINING TYPES * FROM user;")
        common.execute_and_fetch_all(
            admin_connection.cursor(), "REVOKE NOTHING ON NODES CONTAINING LABELS :label4 FROM user;"
        )
...
def test_weighted_shortest_path_denied_label_1(switch):
    ...
    try:
        ...
        common.execute_and_fetch_all(
            admin_connection.cursor(),
            "REVOKE READ ON NODES CONTAINING LABELS :label0, :label2, :label3, :label4 FROM user;",
        )
        common.execute_and_fetch_all(
            admin_connection.cursor(), "REVOKE NOTHING ON NODES CONTAINING LABELS :label1 FROM user;"
        )
        common.execute_and_fetch_all(admin_connection.cursor(), "REVOKE READ ON EDGES CONTAINING TYPES * FROM user;")
...
def test_weighted_shortest_path_denied_edge_type_3(switch):
    ...
    common.execute_and_fetch_all(
        admin_connection.cursor(),
        "GRANT READ ON EDGES CONTAINING TYPES :edge_type_1, :edge_type_2, :edge_type_4 TO user;",
    )
    common.execute_and_fetch_all(
        admin_connection.cursor(), "GRANT NOTHING ON EDGES CONTAINING TYPES :edge_type_3 TO user;"
    )
    user_connection = common.connect(username="user", password="test")
    ...
    try:
        ...
        common.execute_and_fetch_all(
            admin_connection.cursor(),
            "REVOKE READ ON EDGES CONTAINING TYPES :edge_type_1, :edge_type_2, :edge_type_4 FROM user;",
        )
        common.execute_and_fetch_all(
            admin_connection.cursor(), "REVOKE NOTHING ON EDGES CONTAINING TYPES :edge_type_3 FROM user;"
        )
...
def test_bfs_single_source_all_edge_types_all_labels_denied(switch):
    ...
    try:
        if switch:
            common.switch_db(user_connection.cursor())
        total_paths_results = common.execute_and_fetch_all(
            user_connection.cursor(), "MATCH p=(n)-[r *BFS]->(m) RETURN p;"
        )
