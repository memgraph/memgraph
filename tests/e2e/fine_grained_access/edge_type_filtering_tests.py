...
#     admin_connection = common.connect(username="admin", password="test")
#     common.execute_and_fetch_all(admin_connection.cursor(), "GRANT READ ON NODES CONTAINING LABELS :label1, :label2, :label3 TO user;")
#     common.execute_and_fetch_all(admin_connection.cursor(), "GRANT READ ON EDGES CONTAINING TYPES :edgeType2 TO user;")
#     common.execute_and_fetch_all(admin_connection.cursor(), "GRANT NOTHING ON EDGES CONTAINING TYPES :edgeType1 TO user;")
#     user_connection = common.connect(username="user", password="test")
...
#     admin_connection = common.connect(username="admin", password="test")
#     common.execute_and_fetch_all(admin_connection.cursor(), "GRANT READ ON NODES CONTAINING LABELS :label1,:label3 TO user;")
#     common.execute_and_fetch_all(admin_connection.cursor(), "GRANT READ ON EDGES CONTAINING TYPES :edgeType1, :edgeType2 TO user;")
...
#     admin_connection = common.connect(username="admin", password="test")
#     common.execute_and_fetch_all(admin_connection.cursor(), "GRANT READ ON NODES CONTAINING LABELS :label1,:label2 TO user;")
#     common.execute_and_fetch_all(admin_connection.cursor(), "GRANT READ ON EDGES CONTAINING TYPES :edgeType1, :edgeType2 TO user;")
