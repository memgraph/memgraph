...
def get_mock_proc_ctx(is_write: bool) -> mgp_mock.ProcCtx:
    ...
    NODE_INFO = {
        0: {"label": "Person", "name": "Peter", "surname": "Yang", "permanent_id": 0},
        1: {"label": "Team", "name": "Engineering", "permanent_id": 1},
        2: {"label": "Repository", "name": "Memgraph", "permanent_id": 2},
        3: {"label": "Repository", "name": "MAGE", "permanent_id": 3},
        4: {"label": "Repository", "name": "GQLAlchemy", "permanent_id": 4},
        5: {"label": "Company:Startup", "name": "Memgraph", "permanent_id": 5},
        6: {"label": "File", "name": "welcome_to_engineering.txt", "permanent_id": 6},
        7: {"label": "Storage", "name": "Google Drive", "permanent_id": 7},
        8: {"label": "Storage", "name": "Notion", "permanent_id": 8},
        9: {"label": "File", "name": "welcome_to_memgraph.txt", "permanent_id": 9},
        10: {"label": "Person", "name": "Carl", "permanent_id": 10},
        11: {"label": "Folder", "name": "engineering_folder", "permanent_id": 11},
        12: {"label": "Person", "name": "Anna", "permanent_id": 12},
        13: {"label": "Folder", "name": "operations_folder", "permanent_id": 13},
        14: {"label": "Team", "name": "Operations", "permanent_id": 14},
        15: {"label": "File", "name": "operations101.txt", "permanent_id": 15},
        16: {"label": "File", "name": "expenses2022.csv", "permanent_id": 16},
        17: {"label": "File", "name": "salaries2022.csv", "permanent_id": 17},
        18: {"label": "File", "name": "engineering101.txt", "permanent_id": 18},
        19: {"label": "File", "name": "working_with_github.txt", "permanent_id": 19},
        20: {"label": "File", "name": "working_with_notion.txt", "permanent_id": 20},
        21: {"label": "Team", "name": "Marketing", "permanent_id": 21},
        22: {"label": "Person", "name": "Julie", "permanent_id": 22},
        23: {"label": "Account", "name": "Facebook", "permanent_id": 23},
        24: {"label": "Account", "name": "LinkedIn", "permanent_id": 24},
        25: {"label": "Account", "name": "HackerNews", "permanent_id": 25},
        26: {"label": "File", "name": "welcome_to_marketing.txt", "permanent_id": 26},
    }
    EDGE_INFO = {
