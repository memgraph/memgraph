...
def multi_role_connection(request):
    ...
    with GraphDatabase.driver(MG_URI, auth=("", "")) as client:
        with client.session() as session:
            ...
            session.run("GRANT CREATE ON NODES CONTAINING LABELS * TO admin;").consume()
            session.run("GRANT READ ON NODES CONTAINING LABELS * TO admin;").consume()
            session.run("GRANT UPDATE ON NODES CONTAINING LABELS * TO admin;").consume()
            session.run("GRANT DELETE ON NODES CONTAINING LABELS * TO admin;").consume()
            session.run("GRANT CREATE ON EDGES CONTAINING TYPES * TO admin;").consume()
            session.run("GRANT READ ON EDGES CONTAINING TYPES * TO admin;").consume()
            session.run("GRANT UPDATE ON EDGES CONTAINING TYPES * TO admin;").consume()
            session.run("GRANT DELETE ON EDGES CONTAINING TYPES * TO admin;").consume()
            session.run("GRANT ALL PRIVILEGES TO architect;").consume()
            session.run("GRANT CREATE ON NODES CONTAINING LABELS * TO architect;").consume()
            session.run("GRANT READ ON NODES CONTAINING LABELS * TO architect;").consume()
            session.run("GRANT UPDATE ON NODES CONTAINING LABELS * TO architect;").consume()
            session.run("GRANT DELETE ON NODES CONTAINING LABELS * TO architect;").consume()
            session.run("GRANT CREATE ON EDGES CONTAINING TYPES * TO architect;").consume()
            session.run("GRANT READ ON EDGES CONTAINING TYPES * TO architect;").consume()
            session.run("GRANT UPDATE ON EDGES CONTAINING TYPES * TO architect;").consume()
            session.run("GRANT DELETE ON EDGES CONTAINING TYPES * TO architect;").consume()
            session.run("GRANT MATCH, CREATE, STREAM, MULTI_DATABASE_USE TO user;").consume()
            session.run("GRANT CREATE ON NODES CONTAINING LABELS * TO user;").consume()
            session.run("GRANT READ ON NODES CONTAINING LABELS * TO user;").consume()
            session.run("GRANT UPDATE ON NODES CONTAINING LABELS * TO user;").consume()
            session.run("GRANT DELETE ON NODES CONTAINING LABELS * TO user;").consume()
            session.run("GRANT CREATE ON EDGES CONTAINING TYPES * TO user;").consume()
            session.run("GRANT READ ON EDGES CONTAINING TYPES * TO user;").consume()
            session.run("GRANT UPDATE ON EDGES CONTAINING TYPES * TO user;").consume()
            session.run("GRANT DELETE ON EDGES CONTAINING TYPES * TO user;").consume()
