...
def test_db_memory_grows_with_parallel_execution():
    """
    ...
    assert after > before, f"db_memory_tracked should grow after parallel read query. before={before} after={after}"
