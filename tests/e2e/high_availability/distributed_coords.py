...
def get_instances_description_no_setup_durability(test_name: str):
    return {
        "instance_1": {
            "args": [
                "--bolt-port",
...
def test_branching_point_snapshot_recovery(test_name):
    instances_description = get_instances_description_no_setup(test_name=test_name)
    ...
    assert contains_wal_old_dir == True
