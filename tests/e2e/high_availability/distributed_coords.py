    ...
    return {
        ...
        "coordinator_1": {
            "args": [
                ...
                f"--nuraft-log-file={get_logs_path(file, test_name)}/coordinator_1.log",
        ...
        "coordinator_2": {
            "args": [
                ...
                f"--ha_durability={use_durability}",
                f"--nuraft-log-file={get_logs_path(file, test_name)}/coordinator_2.log",
                "--coordinator-hostname",
                "localhost",
            ],
        ...
        "coordinator_3": {
            "args": [
                ...
                f"--ha_durability={use_durability}",
                f"--nuraft-log-file={get_logs_path(file, test_name)}/coordinator_3.log",
                "--coordinator-hostname",
                "localhost",
            ],
...
#     ]
#
#     mg_sleep_and_assert_until_role_change(lambda: execute_and_fetch_all(new_main_cursor, "SHOW REPLICATION ROLE;")[0][0], "main")
