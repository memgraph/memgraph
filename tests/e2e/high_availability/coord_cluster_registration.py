    ...
    return {
        ...
        "coordinator_1": {
            "args": [
                ...
                f"--nuraft-log-file={get_logs_path(file, test_name)}/coordinator_1_nuraft.log",
            ],
        ...
        "coordinator_2": {
            "args": [
                ...
                f"--nuraft-log-file={get_logs_path(file, test_name)}/coordinator_2_nuraft.log",
            ],
        ...
        "coordinator_3": {
            "args": [
                ...
                f"--nuraft-log-file={get_logs_path(file, test_name)}/coordinator_3_nuraft.log",
            ],
