    ...
    return {
        "instance_1": {
            "args": [
                ...
                f"--cluster-key-file={interactive_mg_runner.SCRIPT_DIR}/instance1.key",
                f"--cluster-cert-file={interactive_mg_runner.SCRIPT_DIR}/instance1.crt",
                f"--cluster-ca-file={interactive_mg_runner.SCRIPT_DIR}/ca.crt",
            ],
        ...
        "instance_2": {
            "args": [
                ...
                "--storage-wal-file-size-kib=1",
                f"--cluster-key-file={interactive_mg_runner.SCRIPT_DIR}/instance2.key",
                f"--cluster-cert-file={interactive_mg_runner.SCRIPT_DIR}/instance2.crt",
                f"--cluster-ca-file={interactive_mg_runner.SCRIPT_DIR}/ca.crt",
            ],
        ...
        "instance_3": {
            "args": [
                ...
                "--storage-wal-file-size-kib=1",
                f"--cluster-key-file={interactive_mg_runner.SCRIPT_DIR}/instance3.key",
                f"--cluster-cert-file={interactive_mg_runner.SCRIPT_DIR}/instance3.crt",
                f"--cluster-ca-file={interactive_mg_runner.SCRIPT_DIR}/ca.crt",
            ],
        ...
        "coordinator_1": {
            "args": [
                ...
                f"--cluster-key-file={interactive_mg_runner.SCRIPT_DIR}/coord1.key",
                f"--cluster-cert-file={interactive_mg_runner.SCRIPT_DIR}/coord1.crt",
                f"--cluster-ca-file={interactive_mg_runner.SCRIPT_DIR}/ca.crt",
            ],
        ...
        "coordinator_2": {
            "args": [
                ...
                "--coordinator-hostname=localhost",
                f"--cluster-key-file={interactive_mg_runner.SCRIPT_DIR}/coord2.key",
                f"--cluster-cert-file={interactive_mg_runner.SCRIPT_DIR}/coord2.crt",
                f"--cluster-ca-file={interactive_mg_runner.SCRIPT_DIR}/ca.crt",
            ],
        ...
        "coordinator_3": {
            "args": [
                ...
                "--coordinator-hostname=localhost",
                f"--cluster-key-file={interactive_mg_runner.SCRIPT_DIR}/coord3.key",
                f"--cluster-cert-file={interactive_mg_runner.SCRIPT_DIR}/coord3.crt",
                f"--cluster-ca-file={interactive_mg_runner.SCRIPT_DIR}/ca.crt",
            ],
