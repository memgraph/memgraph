...
def test_all_show_metrics_info_values_are_present(memgraph):
    expected_metrics = [
        ...
        {"name": "ActiveLabelPropertyCompositeIndices", "type": "Index", "metric type": "Counter"},
        ...
        {"name": "ScanAllByLabelPropertyCompositeValueOperator", "type": "Operator", "metric type": "Counter"},
