...
def test_all_show_metrics_info_values_are_present(memgraph):
    expected_metrics = [
        ...
        {"name": "DemoteToReplicaRpcFail", "type": "HighAvailability", "metric type": "Counter"},
        {"name": "DemoteToReplicaRpcSuccess", "type": "HighAvailability", "metric type": "Counter"},
        ...
        {"name": "RegisterReplicaRpcFail", "type": "HighAvailability", "metric type": "Counter"},
        {"name": "RegisterReplicaRpcSuccess", "type": "HighAvailability", "metric type": "Counter"},
