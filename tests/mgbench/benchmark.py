...
SETUP_AUTH_QUERIES = [
    ...
    ("GRANT CREATE ON EDGE_TYPES *, READ ON EDGE_TYPES *, UPDATE ON EDGE_TYPES *, DELETE ON EDGE_TYPES * TO user;", {}),
    ("GRANT CREATE ON LABELS *, READ ON LABELS *, UPDATE ON LABELS *, DELETE ON LABELS * TO user;", {}),
]
