...
NLOHMANN_JSON_SERIALIZE_ENUM(RaftLogAction,
                             {{RaftLogAction::REGISTER_REPLICATION_INSTANCE, "register"},
                              ...
                              {RaftLogAction::UPDATE_UUID_FOR_INSTANCE, "add_coordinator_instance"},
                              {RaftLogAction::OPEN_LOCK_REGISTER_REPLICATION_INSTANCE, "add_coordinator_instance"},
                              {RaftLogAction::OPEN_LOCK_UNREGISTER_REPLICATION_INSTANCE, "add_coordinator_instance"},
                              {RaftLogAction::OPEN_LOCK_FAILOVER, "add_coordinator_instance"},
                              {RaftLogAction::OPEN_LOCK_SET_INSTANCE_AS_MAIN, "add_coordinator_instance"}})
