...
extern "C" int mgp_init_module(struct mgp_module *module, struct mgp_memory *memory) {
  try {
    ...
    AddProcedure(Nodes::Link,
                 std::string(Nodes::kProcedureLink),
    ...
    AddProcedure(
        ...
        Nodes::kProcedureRelationshipTypes,
        ...
        {mgp::Return(Nodes::kResultRelationshipTypes, {mgp::Type::List, mgp::Type::Map})},
        module,
        memory);

    AddProcedure(Nodes::Delete,
                 Nodes::kProcedureDelete,
                 mgp::ProcedureType::Write,
                 {mgp::Parameter(Nodes::kDeleteArg1, mgp::Type::Any)},
                 {},
                 module,
                 memory);
    ...
    AddProcedure(
        ...
        std::string(Nodes::kProcedureRelationshipsExist),
        mgp::ProcedureType::Read,
        ...
        {mgp::Return(std::string(Nodes::kReturnRelationshipsExist), {mgp::Type::Map, mgp::Type::Any})},
        module,
        memory);
