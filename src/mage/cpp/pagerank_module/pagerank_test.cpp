...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        std::make_tuple(
            pagerank_alg::PageRankGraph(7, 30, {{0, 6}, {3, 0}, {6, 2}, {0, 3}, {2, 3}, {6, 4}, {1, 1}, {2, 0},
                                                {0, 3}, {5, 0}, {0, 4}, {5, 2}, {1, 5}, {5, 3}, {2, 3}, {6, 1},
                                                {2, 0}, {6, 1}, {2, 6}, {2, 2}, {0, 0}, {6, 0}, {6, 0}, {0, 6},
                                                {3, 3}, {6, 3}, {1, 3}, {4, 0}, {1, 2}, {2, 1}}),
            std::vector<double>{
                0.318471859, 0.075311781, 0.071307161, 0.295999683, 0.081155915, 0.037432346, 0.120321254})));
