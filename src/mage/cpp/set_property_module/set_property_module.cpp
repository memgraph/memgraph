...
extern "C" int mgp_init_module(struct mgp_module *module, struct mgp_memory *memory) {
  try {
    const mgp::MemoryDispatcherGuard guard(memory);
    AddProcedure(CopyPropertyNode2Node,
                 ...
                 {mgp::Return(kResult, mgp::Type::Bool)},
                 module,
                 memory);

    AddProcedure(CopyPropertyNode2Rel,
    ...
    AddProcedure(CopyPropertyRel2Node,
    ...
    AddProcedure(CopyPropertyRel2Rel,
                 "copyPropertyRel2Rel",
                 mgp::ProcedureType::Write,
                 {mgp::Parameter(kSourceRel, mgp::Type::Relationship),
                  mgp::Parameter(kSourceProperties, {mgp::Type::List, mgp::Type::String}),
