...
TEST(OnlineBC, SetBC) {
  const auto example_graph =
      mg_generate::BuildGraph(20,
                              {{0, 1},   {0, 3},   {0, 9},   {0, 10},  {1, 2},   {2, 3},   {2, 4},  {3, 5},  {4, 7},
...
TEST(OnlineBC, GetBCInconsistent) {
  const auto example_graph = mg_generate::BuildGraph(
      6, {{0, 1}, {0, 2}, {1, 2}, {2, 3}, {3, 4}, {3, 5}, {4, 5}}, mg_graph::GraphType::kUndirectedGraph);
...
TEST(OnlineBC, UpdateBCCreateAttachNode) {
  ...
  const auto current_graph =
      mg_generate::BuildGraph(20,
                              {{0, 1},  {0, 3},   {0, 9},   {0, 10},  {1, 2},   {2, 3},   {2, 4},   {3, 5},
...
TEST(OnlineBC, UpdateBCInsertEdgeOneNodeIsolated) {
  const auto prior_graph = mg_generate::BuildGraph(
      7, {{0, 1}, {0, 2}, {1, 2}, {2, 3}, {3, 4}, {3, 5}, {4, 5}}, mg_graph::GraphType::kUndirectedGraph);
...
TEST(OnlineBC, UpdateBCInsertEdgeConnectDisconnected) {
  const auto prior_graph = mg_generate::BuildGraph(
      6, {{0, 1}, {0, 2}, {1, 2}, {3, 4}, {3, 5}, {4, 5}}, mg_graph::GraphType::kUndirectedGraph);
