...
inline bool is_valid(std::string_view s) { return is_valid(s.begin(), s.end()); }
...
inline bool starts_with_bom(std::string_view s) { return starts_with_bom(s.begin(), s.end()); }
