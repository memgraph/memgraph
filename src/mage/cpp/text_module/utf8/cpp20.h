...
inline bool is_valid(const std::u8string &s) { return is_valid(s.begin(), s.end()); }
...
inline bool starts_with_bom(const std::u8string &s) { return starts_with_bom(s.begin(), s.end()); }
