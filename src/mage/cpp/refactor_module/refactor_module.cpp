...
extern "C" int mgp_init_module(struct mgp_module *module, struct mgp_memory *memory) {
  try {
    ...
    AddProcedure(Refactor::From,
                 Refactor::kProcedureFrom,
                 ...
                 {mgp::Return(Refactor::kFromResult, mgp::Type::Relationship)},
                 module,
                 memory);

    AddProcedure(Refactor::To,
                 Refactor::kProcedureTo,
                 mgp::ProcedureType::Write,
                 {mgp::Parameter(Refactor::kToArg1, mgp::Type::Relationship),
                  mgp::Parameter(Refactor::kToArg2, mgp::Type::Node)},
                 {mgp::Return(Refactor::kToResult, mgp::Type::Relationship)},
                 module,
                 memory);

    AddProcedure(
        Refactor::Categorize,
        Refactor::kProcedureCategorize,
        mgp::ProcedureType::Write,
        {
            ...
            mgp::Parameter(
                Refactor::kArgumentsCopyPropKeys, {mgp::Type::List, mgp::Type::String}, mgp::Value(mgp::List{})),
        },
        {mgp::Return(Refactor::kReturnCategorize, mgp::Type::String)},
        module,
        memory);

    AddProcedure(
        Refactor::CloneNodes,
        Refactor::kProcedureCloneNodes,
        mgp::ProcedureType::Write,
        {mgp::Parameter(Refactor::kArgumentsNodesToClone, {mgp::Type::List, mgp::Type::Node}),
         ...
         mgp::Parameter(
             Refactor::kArgumentsSkipPropClone, {mgp::Type::List, mgp::Type::String}, mgp::Value(mgp::List{}))},
    ...
    AddProcedure(
        Refactor::CloneSubgraphFromPaths,
        Refactor::kProcedureCSFP,
        mgp::ProcedureType::Write,
    ...
    AddProcedure(Refactor::RenameLabel,
                 Refactor::kProcedureRenameLabel,
                 mgp::ProcedureType::Write,
                 ...
                 {mgp::Return(Refactor::kRenameLabelResult, mgp::Type::Int)},
                 module,
                 memory);

    AddProcedure(Refactor::RenameNodeProperty,
                 Refactor::kProcedureRenameNodeProperty,
                 mgp::ProcedureType::Write,
                 ...
                 {mgp::Return(Refactor::kRenameNodePropertyResult, mgp::Type::Int)},
                 module,
                 memory);

    AddProcedure(Refactor::Invert,
                 std::string(Refactor::kProcedureInvert),
                 mgp::ProcedureType::Write,
                 {mgp::Parameter(std::string(Refactor::kArgumentRelationship), mgp::Type::Any)},
                 {mgp::Return(std::string(Refactor::kResultIdInvert), mgp::Type::Int),
                  mgp::Return(std::string(Refactor::kResultRelationshipInvert), mgp::Type::Relationship),
                  mgp::Return(std::string(Refactor::kResultErrorInvert), mgp::Type::String)},
                 module,
                 memory);

    AddProcedure(Refactor::CollapseNode,
                 std::string(Refactor::kProcedureCollapseNode),
                 mgp::ProcedureType::Write,
                 {mgp::Parameter(std::string(Refactor::kArgumentNodesCollapseNode), mgp::Type::Any),
                  mgp::Parameter(std::string(Refactor::kArgumentTypeCollapseNode), mgp::Type::String)},
                 {mgp::Return(std::string(Refactor::kReturnIdCollapseNode), mgp::Type::Int),
                  mgp::Return(std::string(Refactor::kReturnRelationshipCollapseNode), mgp::Type::Relationship)},
                 module,
                 memory);

    AddProcedure(Refactor::DeleteAndReconnect,
                 Refactor::kProcedureDeleteAndReconnect,
                 mgp::ProcedureType::Write,
    ...
    AddProcedure(Refactor::ExtractNode,
                 Refactor::kProcedureExtractNode,
                 mgp::ProcedureType::Write,
    ...
    AddProcedure(Refactor::NormalizeAsBoolean,
                 Refactor::kProcedureNormalizeAsBoolean,
                 mgp::ProcedureType::Write,
    ...
    AddProcedure(Refactor::RenameType,
                 Refactor::kProcedureRenameType,
                 mgp::ProcedureType::Write,
                 ...
                 {mgp::Return(Refactor::kResultRenameType, mgp::Type::Int)},
                 module,
                 memory);

    AddProcedure(
        Refactor::RenameTypeProperty,
        std::string(Refactor::kProcedureRenameTypeProperty),
        mgp::ProcedureType::Write,
        {mgp::Parameter(std::string(Refactor::kRenameTypePropertyArg1), mgp::Type::String),
         mgp::Parameter(std::string(Refactor::kRenameTypePropertyArg2), mgp::Type::String),
         mgp::Parameter(std::string(Refactor::kRenameTypePropertyArg3), {mgp::Type::List, mgp::Type::Relationship})},
        {mgp::Return(std::string(Refactor::kRenameTypePropertyResult), mgp::Type::Int)},
        module,
        memory);

    AddProcedure(Refactor::MergeNodes,
                 Refactor::kProcedureMergeNodes,
                 mgp::ProcedureType::Write,
                 ...
                 {mgp::Return(Refactor::kMergeNodesResult, mgp::Type::Node)},
                 module,
                 memory);
