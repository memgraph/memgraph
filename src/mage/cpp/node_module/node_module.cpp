...
extern "C" int mgp_init_module(struct mgp_module *module, struct mgp_memory *memory) {
  try {
    ...
    AddProcedure(Node::RelationshipsExist,
                 std::string(Node::kProcedureRelationshipsExist),
                 ...
                 {mgp::Return(std::string(Node::kReturnRelationshipsExist), {mgp::Type::Map, mgp::Type::Any})},
                 module,
                 memory);

    AddProcedure(
        Node::RelationshipExists,
        Node::kProcedureRelationshipExists,
        mgp::ProcedureType::Read,
        ...
        {mgp::Return(Node::kReturnRelationshipExists, mgp::Type::Bool)},
        module,
        memory);

    AddProcedure(
        Node::RelationshipTypes,
        Node::kProcedureRelationshipTypes,
        mgp::ProcedureType::Read,
        ...
        {mgp::Return(Node::kResultRelationshipTypes, {mgp::Type::List, mgp::Type::String})},
        module,
        memory);

    mgp::AddFunction(Node::DegreeIn,
                     Node::kFunctionDegreeIn,
                     {mgp::Parameter(Node::kDegreeInArg1, mgp::Type::Node),
                      mgp::Parameter(Node::kDegreeInArg2, mgp::Type::String, "")},
                     module,
                     memory);

    mgp::AddFunction(Node::DegreeOut,
                     Node::kFunctionDegreeOut,
