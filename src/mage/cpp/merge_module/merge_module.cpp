...
extern "C" int mgp_init_module(struct mgp_module *module, struct mgp_memory *memory) {
  try {
    ...
    AddProcedure(Merge::Node,
                 std::string(Merge::kProcedureNode),
                 ...
                 {mgp::Return(std::string(Merge::kNodeRes), mgp::Type::Node)},
                 module,
                 memory);

    AddProcedure(Merge::Relationship,
                 Merge::kProcedureRelationship,
                 mgp::ProcedureType::Write,
                 ...
                 {mgp::Return(Merge::kRelationshipResult, mgp::Type::Relationship)},
                 module,
                 memory);
