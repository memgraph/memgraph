...
extern "C" int mgp_init_module(struct mgp_module *module, struct mgp_memory *memory) {
  try {
    ...
    mgp::AddFunction(
        Map::FromLists,
        std::string(Map::kProcedureFromLists),
    ...
    mgp::AddFunction(Map::FromValues,
                     Map::kProcedureFromValues,
                     {mgp::Parameter(Map::kFromValuesArg1, {mgp::Type::List, mgp::Type::Any})},
                     module,
                     memory);

    mgp::AddFunction(Map::SetKey,
                     Map::kProcedureSetKey,
                     {mgp::Parameter(Map::kSetKeyArg1, mgp::Type::Map),
                      mgp::Parameter(Map::kSetKeyArg2, mgp::Type::String),
