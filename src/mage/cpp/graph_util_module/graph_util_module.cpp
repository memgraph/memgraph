...
extern "C" int mgp_init_module(struct mgp_module *module, struct mgp_memory *memory) {
  try {
    ...
    AddProcedure(Ancestors,
                 kProcedureAncestors,
                 mgp::ProcedureType::Read,
                 {mgp::Parameter(kArgumentNode, mgp::Type::Node)},
                 {mgp::Return(kReturnAncestors, ancestors_return)},
                 module,
                 memory);
    ...
    AddProcedure(
        ...
        {mgp::Return(kResultConnections, chain_nodes_output_connections)},
        module,
        memory);
    ...
    AddProcedure(ConnectNodes,
                 kProcedureConnectNodes,
                 mgp::ProcedureType::Read,
                 {mgp::Parameter(kArgumentNodes, connect_nodes_input)},
                 {mgp::Return(kReturnConnections, connect_nodes_return)},
                 module,
                 memory);
    ...
    AddProcedure(Descendants,
                 kProcedureDescendants,
                 mgp::ProcedureType::Read,
                 {mgp::Parameter(kArgumentNode, mgp::Type::Node)},
                 {mgp::Return(kReturnDescendants, descendants_return)},
                 module,
                 memory);
    ...
    AddProcedure(TopologicalSort,
                 kProcedureTopologicalSort,
                 mgp::ProcedureType::Read,
                 {},
                 {mgp::Return(kReturnSortedNodes, topological_sort_return)},
                 module,
                 memory);
