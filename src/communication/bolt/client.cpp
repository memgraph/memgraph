...
QueryData Client::Execute(const std::string &query, const Value::map_t &parameters) {
...
std::optional<Value::map_t> Client::Route(const Value::map_t &routing, const std::vector<Value> &bookmarks,
