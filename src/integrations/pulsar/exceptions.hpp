...
class ConsumerFailedToInitializeException : public PulsarStreamException {
 public:
  constexpr ConsumerFailedToInitializeException(const std::string &consumer_name, const std::string &error)
...
class ConsumerRunningException : public PulsarStreamException {
 public:
  constexpr explicit ConsumerRunningException(const std::string &consumer_name)
...
class ConsumerStoppedException : public PulsarStreamException {
 public:
  constexpr explicit ConsumerStoppedException(const std::string &consumer_name)
...
class ConsumerCheckFailedException : public PulsarStreamException {
 public:
  constexpr explicit ConsumerCheckFailedException(const std::string &consumer_name, const std::string &error)
...
class ConsumerStartFailedException : public PulsarStreamException {
 public:
  constexpr explicit ConsumerStartFailedException(const std::string &consumer_name, const std::string &error)
...
class TopicNotFoundException : public PulsarStreamException {
 public:
  constexpr TopicNotFoundException(const std::string &consumer_name, const std::string &topic_name)
...
class ConsumerReadMessagesFailedException : public PulsarStreamException {
 public:
  constexpr ConsumerReadMessagesFailedException(const std::string_view consumer_name, const std::string_view error)
...
class ConsumerAcknowledgeMessagesFailedException : public PulsarStreamException {
 public:
  constexpr explicit ConsumerAcknowledgeMessagesFailedException(const std::string_view consumer_name)
