...
class AuthQueryHandler {
 public:
  ...
  virtual void GrantPrivilege(
      ...
      const std::vector<std::unordered_map<AuthQuery::EntityPrivilege, std::vector<std::string>>> &label_privileges,
      const std::vector<std::unordered_map<AuthQuery::EntityPrivilege, std::vector<std::string>>>
