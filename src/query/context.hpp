...
struct StoppingContext {
  ...
  /// i.e. legacy behaviour. Wired by the runner in Phase 3; null in Phase 1/2 so this is a pure no-op now.
...
struct ExecutionContext {
  ...
  /// active or yield is suppressed (e.g. a synchronous nested sub-pull). nullptr in Phase 1/2 (no driver
