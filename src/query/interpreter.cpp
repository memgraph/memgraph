    ...
    case SystemInfoQuery::InfoType::STORAGE: {
      ...
      handler = [storage = current_db.db_acc_->get()->storage(),
        ...
        std::vector<std::vector<TypedValue>> results{
            ...
            {TypedValue("malloc_memory_tracked"),
             TypedValue(utils::GetReadableSize(static_cast<double>(utils::malloc_memory_tracker.Amount())))},
            {TypedValue("malloc_allocation_limit"),
             TypedValue(utils::GetReadableSize(static_cast<double>(utils::malloc_memory_tracker.HardLimit())))},
            {TypedValue("mmap_memory_tracked"),
             TypedValue(utils::GetReadableSize(static_cast<double>(utils::mmap_memory_tracker.Amount())))},
            {TypedValue("mmap_allocation_limit"),
             TypedValue(utils::GetReadableSize(static_cast<double>(utils::mmap_memory_tracker.HardLimit())))},
