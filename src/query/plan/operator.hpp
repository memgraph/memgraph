...
using LogicalOperatorCompositeVisitor = utils::CompositeVisitor<
    ...
    ScanAllByEdgeId, ScanAllByPointDistance, ScanAllByPointWithinbbox, Expand, ExpandVariable, ConstructNamedPath,
    ...
    LoadCsv, Foreach, EmptyResult, EvaluatePatternFilter, Apply, IndexedJoin, HashJoin, RollUpApply, PeriodicCommit,
    PeriodicSubquery>;
