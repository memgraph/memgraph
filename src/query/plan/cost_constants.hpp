...
inline constexpr double kScanAllByVertexProperty{1.1};
inline constexpr double kScanAllByVertexPropertyValue{1.1};
inline constexpr double kScanAllByVertexPropertyRange{1.1};
