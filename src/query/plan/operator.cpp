...
#ifdef MG_ENTERPRISE
  if (license::global_license_checker.IsEnterpriseEnabledFast() && context.auth_checker &&
...
#ifdef MG_ENTERPRISE
  if (license::global_license_checker.IsEnterpriseEnabledFast()) {
...
#ifdef MG_ENTERPRISE
    if (license::global_license_checker.IsEnterpriseEnabledFast() && context.auth_checker && !FindNextVertex(context)) {
      return false;
    }
#endif
