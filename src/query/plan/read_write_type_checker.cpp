...
PRE_VISIT(ScanAllByEdgePropertyValue, RWType::R, true)
PRE_VISIT(ScanAllByEdgePropertyRange, RWType::R, true)
PRE_VISIT(ScanAllByEdgeId, RWType::R, true)
PRE_VISIT(ScanAllByVertexProperty, RWType::R, true)
PRE_VISIT(ScanAllByVertexPropertyValue, RWType::R, true)
PRE_VISIT(ScanAllByVertexPropertyRange, RWType::R, true)
...
PRE_VISIT(ScanParallelByVertexPropertyValue, RWType::R, true)
PRE_VISIT(ScanParallelByVertexPropertyRange, RWType::R, true)
