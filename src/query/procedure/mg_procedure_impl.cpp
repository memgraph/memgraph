...
#ifdef MG_ENTERPRISE
    if (memgraph::license::global_license_checker.IsEnterpriseEnabledFast() && ctx && ctx->auth_checker &&
...
#ifdef MG_ENTERPRISE
        if (memgraph::license::global_license_checker.IsEnterpriseEnabledFast() && graph->ctx &&
