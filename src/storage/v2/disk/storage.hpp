...
class DiskStorage final : public Storage {
 public:
  ...
  VertexAccessor CreateVertexFromDisk(Transaction *transaction, utils::SkipListDb<Vertex>::Accessor &accessor,
  ...
  std::vector<EdgeAccessor> InEdges(const VertexAccessor *dst_vertex,
                                    ...
                                    Transaction *transaction, View view, HopsLimit *hops_limit = nullptr);
