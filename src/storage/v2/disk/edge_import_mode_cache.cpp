...
utils::SkipList<Vertex, memory::ArenaAwareAllocator<char>>::Accessor EdgeImportModeCache::AccessToVertices() {
  return vertices_.access();
}

utils::SkipList<Edge, memory::ArenaAwareAllocator<char>>::Accessor EdgeImportModeCache::AccessToEdges() {
