...
class Storage {
 ...
 public:
  ...
  /// Replace the stored metric handles with @p new_handles. Only safe on a
  /// clean storage with zero committed transactions. No indices,
  /// constraints, TTL, or in-flight transactions exist that may hold copies of
  /// the old handles.
