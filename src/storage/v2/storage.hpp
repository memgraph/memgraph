...
>>>>>>> disk-storage-v1
     ...
     public:
      ...
      /// * `ConstraintViolation`: the changes made by this transaction violate an existence or unique constraint. In
      /// this case the transaction is automatically aborted.
      /// @throw std::bad_alloc
...
>>>>>>> disk-storage-v1
    ...
    utils::BasicResult<RegisterReplicaError, void> RegisterReplica(std::string name, io::network::Endpoint endpoint,
      ...
      return RegisterReplica(name, endpoint, replication_mode, registration_mode,
