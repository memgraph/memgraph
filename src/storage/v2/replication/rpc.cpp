...
void DurableTimestampReq::Save(const DurableTimestampReq &self, memgraph::slk::Builder *builder) {
  memgraph::slk::Save(self, builder);
}
void DurableTimestampReq::Load(DurableTimestampReq *self, memgraph::slk::Reader *reader) {
  memgraph::slk::Load(self, reader);
}
void DurableTimestampRes::Save(const DurableTimestampRes &self, memgraph::slk::Builder *builder) {
  memgraph::slk::Save(self, builder);
}
void DurableTimestampRes::Load(DurableTimestampRes *self, memgraph::slk::Reader *reader) {
  memgraph::slk::Load(self, reader);
}
...
constexpr utils::TypeInfo storage::replication::DurableTimestampReq::kType{utils::TypeId::REP_DURABLE_TIMESTAMP_REQ,
                                                                           "DurableTimestampReq", nullptr};

constexpr utils::TypeInfo storage::replication::DurableTimestampRes::kType{utils::TypeId::REP_DURABLE_TIMESTAMP_RES,
                                                                           "DurableTimestampRes", nullptr};
...
namespace slk {
// Serialize code for DurableTimestampRes
...
// Serialize code for DurableTimestampReq
