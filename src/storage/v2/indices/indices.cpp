...
void Indices::RemoveObsoleteVertexEntries(uint64_t oldest_active_start_timestamp,
                                          utils::SkipList<Vertex>::Accessor &vertices_accessor,
  ...
  vector_index_.RemoveObsoleteEntries(vertices_accessor, token);
}
