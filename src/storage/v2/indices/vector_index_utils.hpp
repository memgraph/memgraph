...
/// Memory tracking is handled automatically by the allocator (jemalloc_arena_allocator_gt)
/// which reports arena-level allocations to global_embeddings_memory_counter.
