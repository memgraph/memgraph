...
enum class Marker : uint8_t {
  ...
  DELTA_LABEL_PROPERTIES_INDEX_STATS_SET = 0x63,
  DELTA_LABEL_PROPERTIES_INDEX_STATS_CLEAR = 0x64,
  ...
  DELTA_DESCRIPTION_SET_LABEL = 0x7a,
  DELTA_DESCRIPTION_DELETE_LABEL = 0x7b,
  DELTA_DESCRIPTION_SET_EDGE_TYPE = 0x7c,
  DELTA_DESCRIPTION_DELETE_EDGE_TYPE = 0x7d,
  DELTA_DESCRIPTION_SET_LABEL_PROPERTY = 0x7e,
  DELTA_DESCRIPTION_DELETE_LABEL_PROPERTY = 0x7f,
  DELTA_DESCRIPTION_SET_EDGE_TYPE_PROPERTY = 0x80,
  DELTA_DESCRIPTION_DELETE_EDGE_TYPE_PROPERTY = 0x81,
  DELTA_DESCRIPTION_SET_DATABASE = 0x82,
  DELTA_DESCRIPTION_DELETE_DATABASE = 0x83,
...
static constexpr std::array kMarkersAll = {
    ...
    Marker::DELTA_DESCRIPTION_SET_LABEL,
    Marker::DELTA_DESCRIPTION_DELETE_LABEL,
    Marker::DELTA_DESCRIPTION_SET_EDGE_TYPE,
    Marker::DELTA_DESCRIPTION_DELETE_EDGE_TYPE,
    Marker::DELTA_DESCRIPTION_SET_LABEL_PROPERTY,
    Marker::DELTA_DESCRIPTION_DELETE_LABEL_PROPERTY,
    Marker::DELTA_DESCRIPTION_SET_EDGE_TYPE_PROPERTY,
    Marker::DELTA_DESCRIPTION_DELETE_EDGE_TYPE_PROPERTY,
    Marker::DELTA_DESCRIPTION_SET_DATABASE,
    Marker::DELTA_DESCRIPTION_DELETE_DATABASE,
    Marker::VALUE_FALSE,
    Marker::VALUE_TRUE,
};
