...
auto InMemoryLabelPropertyIndex::ActiveIndices::ListIndices(uint64_t start_timestamp) const
  ...
  auto const num_indexes = r::fold_left(index_container_->indices_, size_t{}, [](auto sum, auto const &label_map) {
...
InMemoryLabelPropertyIndex::Iterable::Iterator::Iterator(Iterable *self,
                                                         utils::SkipListDb<Entry>::Iterator index_iterator)
    : self_(self),
...
InMemoryLabelPropertyIndex::Iterable::Iterable(
    utils::SkipListDb<InMemoryLabelPropertyIndex::Entry>::Accessor index_accessor,
...
void InMemoryLabelPropertyIndex::ChunkedIterable::Iterator::AdvanceUntilValid() {
  ...
  AdvanceUntilValid_(
      index_iterator_,
      utils::SkipListDb<InMemoryLabelPropertyIndex::Entry>::ChunkedIterator{},
      current_vertex_,
      current_vertex_accessor_,
      self_->storage_,
      self_->transaction_,
