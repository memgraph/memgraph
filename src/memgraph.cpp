...
constexpr const char *kMgUser = "ENTERPRISE_MEMGRAPH_USER";
constexpr const char *kMgPassword = "ENTERPRISE_MEMGRAPH_PASSWORD";
constexpr const char *kMgPassfile = "ENTERPRISE_MEMGRAPH_PASSFILE";
