...
constexpr const char *kMgUser = "ENTERPRISE_MG_USER";
constexpr const char *kMgPassword = "ENTERPRISE_MG_PASSWORD";
constexpr const char *kMgPassfile = "ENTERPRISE_MG_PASSFILE";
