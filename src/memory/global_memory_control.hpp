...
// logs a warning and purges anyway, and if they cannot be restarted they stay off, leaving decay to
// application threads. Calls are serialised with each other but not with a purge of a
