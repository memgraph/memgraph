...
__attribute__((visibility("default"))) void *operator new(const std::size_t size) { return newImpl(size); }
...
__attribute__((visibility("default"))) void operator delete(void *ptr) noexcept { deleteImpl(ptr); }
