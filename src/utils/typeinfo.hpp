...
enum class TypeId : uint64_t {
  ...
  SCAN_PARALLEL_BY_VERTEX_PROPERTY,
  ...
  // Coordinator role/privilege forwarding RPCs (coordinator->leader). Appended at the end of the COORD block so every
  // id above stays stable across a rolling upgrade.
  COORD_CREATE_ROLE_REQ,
  COORD_CREATE_ROLE_RES,
  COORD_DROP_ROLE_REQ,
  COORD_DROP_ROLE_RES,
  COORD_GET_ROLES_REQ,
  COORD_GET_ROLES_RES,
  COORD_GRANT_PRIVILEGE_REQ,
  COORD_GRANT_PRIVILEGE_RES,
  COORD_REVOKE_PRIVILEGE_REQ,
  COORD_REVOKE_PRIVILEGE_RES,
  COORD_GET_ROLE_PRIVILEGES_REQ,
  COORD_GET_ROLE_PRIVILEGES_RES,
  COORD_SET_COORDINATOR_SETTING_REQ,
  COORD_SET_COORDINATOR_SETTING_RES,
  COORD_YIELD_LEADERSHIP_REQ,
  COORD_YIELD_LEADERSHIP_RES,
  COORD_SHOW_COORD_SETTINGS_REQ,
  COORD_SHOW_COORD_SETTINGS_RES,
