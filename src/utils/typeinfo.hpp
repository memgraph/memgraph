...
enum class TypeId : uint64_t {
  ...
  AST_CREATE_VERSION_QUERY,
  AST_USE_VERSION_QUERY,
  AST_SHOW_VERSIONS_QUERY,
  AST_SHOW_VERSION_BRANCH_QUERY,
  AST_SHOW_VERSIONING_GRAPH_QUERY,
  AST_SHOW_CHANGES_QUERY,
  AST_MERGE_VERSION_QUERY,
  AST_REVERT_VERSION_QUERY,
  AST_DROP_VERSION_QUERY,
