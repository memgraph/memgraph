...
constexpr inline uint8_t HostToLittleEndian(uint8_t value) { return value; }
...
constexpr inline int8_t HostToLittleEndian(int8_t value) { return value; }
inline int16_t HostToLittleEndian(int16_t value) {
  return std::bit_cast<int16_t>(htole16(std::bit_cast<uint16_t>(value)));
}
inline int32_t HostToLittleEndian(int32_t value) {
  return std::bit_cast<int32_t>(htole32(std::bit_cast<uint32_t>(value)));
}
inline int64_t HostToLittleEndian(int64_t value) {
  return std::bit_cast<int64_t>(htole64(std::bit_cast<uint64_t>(value)));
}

constexpr inline uint8_t LittleEndianToHost(uint8_t value) { return value; }
...
constexpr inline int8_t LittleEndianToHost(int8_t value) { return value; }
inline int16_t LittleEndianToHost(int16_t value) {
  return std::bit_cast<int16_t>(le16toh(std::bit_cast<uint16_t>(value)));
}
inline int32_t LittleEndianToHost(int32_t value) {
  return std::bit_cast<int32_t>(le32toh(std::bit_cast<uint32_t>(value)));
}
inline int64_t LittleEndianToHost(int64_t value) {
  return std::bit_cast<int64_t>(le64toh(std::bit_cast<uint64_t>(value)));
}

constexpr inline uint8_t HostToBigEndian(uint8_t value) { return value; }
...
constexpr inline int8_t HostToBigEndian(int8_t value) { return value; }
inline int16_t HostToBigEndian(int16_t value) {
  return std::bit_cast<int16_t>(htobe16(std::bit_cast<uint16_t>(value)));
}
inline int32_t HostToBigEndian(int32_t value) {
  return std::bit_cast<int32_t>(htobe32(std::bit_cast<uint32_t>(value)));
}
inline int64_t HostToBigEndian(int64_t value) {
  return std::bit_cast<int64_t>(htobe64(std::bit_cast<uint64_t>(value)));
}

constexpr inline uint8_t BigEndianToHost(uint8_t value) { return value; }
...
constexpr inline int8_t BigEndianToHost(int8_t value) { return value; }
inline int16_t BigEndianToHost(int16_t value) {
  return std::bit_cast<int16_t>(be16toh(std::bit_cast<uint16_t>(value)));
}
inline int32_t BigEndianToHost(int32_t value) {
  return std::bit_cast<int32_t>(be32toh(std::bit_cast<uint32_t>(value)));
}
inline int64_t BigEndianToHost(int64_t value) {
  return std::bit_cast<int64_t>(be64toh(std::bit_cast<uint64_t>(value)));
}
