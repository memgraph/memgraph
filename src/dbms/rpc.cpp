...
void TenantProfileReq::Save(const TenantProfileReq &self, memgraph::slk::Builder *builder) {
  memgraph::slk::Save(self, builder);
}

void TenantProfileReq::Load(TenantProfileReq *self, memgraph::slk::Reader *reader) {
  memgraph::slk::Load(self, reader);
}

void TenantProfileRes::Save(const TenantProfileRes &self, memgraph::slk::Builder *builder) {
  memgraph::slk::Save(self, builder);
}

void TenantProfileRes::Load(TenantProfileRes *self, memgraph::slk::Reader *reader) {
  memgraph::slk::Load(self, reader);
}
