...
class Database {
 ...
 private:
  ...
  utils::MemoryTracker db_memory_tracker_{nullptr};
  utils::MemoryTracker db_embedding_memory_tracker_{nullptr};
  ...
  utils::MemoryTracker db_query_memory_tracker_{nullptr};
