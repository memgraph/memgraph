...
| [cuopt](https://memgraph.com/docs/mage/query-modules/python/cuopt)                                               | Python | A thin client for NVIDIA cuOpt, solving multi-vehicle routing problems (VRP/PDP) with capacity constraints on a GPU-backed cuopt-server.                                                                                          |
