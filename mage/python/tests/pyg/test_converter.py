...
class MockEdge:
    def __init__(self, id: int, from_vertex: MockVertex, to_vertex: MockVertex, 
...
class TestMemgraphPyGConverterExport:
    ...
    def simple_graph(self):
        ...
        v0 = MockVertex(0, ["Person"], {"name": "Alice", "age": 30, "features": [1.0, 2.0]})
        v1 = MockVertex(1, ["Person"], {"name": "Bob", "age": 25, "features": [3.0, 4.0]})
        v2 = MockVertex(2, ["Person", "Admin"], {"name": "Charlie", "age": 35, "features": [5.0, 6.0]})
