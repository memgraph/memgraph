...
constexpr const char *kArgumentWeightProperty = "weight";
constexpr const char *kArgumentColoring = "coloring";
constexpr const char *kArgumentMinGraphShrink = "min_graph_shrink";
constexpr const char *kArgumentCommunityAlgThreshold = "community_alg_threshold";
constexpr const char *kArgumentColoringAlgThreshold = "coloring_alg_threshold";
constexpr const char *kNumberOfThreads = "num_of_threads";
...
void InsertLouvainRecord(mgp_graph *graph, mgp_result *result, mgp_memory *memory, std::uint64_t node_id,
  ...
  mg_utility::InsertIntValueResult(record, kFieldCommunity, static_cast<int>(community), memory);
}
