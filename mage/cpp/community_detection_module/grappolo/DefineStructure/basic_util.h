...
double buildNextLevelGraphOpt(graph *Gin, mgp_graph *mg_graph, graph *Gout, long *C, long numUniqueClusters,
                              int nThreads);
...
inline void Visit(long v, long myCommunity, short *Visited, long *Volts, long *vtxPtr, edge *vtxInd, long *C);
