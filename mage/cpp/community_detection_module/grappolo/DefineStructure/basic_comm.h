...
double parallelLouvianMethodApprox(graph *G, mgp_graph *mg_graph, long *C, int nThreads, double Lower, double thresh,
                                   double *totTime, int *numItr, int percentage);

double parallelLouvianMethodNoMap(graph *G, long *C, int nThreads, double Lower, double thresh, double *totTime,
                                  int *numItr);

double parallelLouvianMethodScale(graph *G, mgp_graph *mg_graph, long *C, int nThreads, double Lower, double thresh,
                                  double *totTime, int *numItr);
...
double parallelLouvianMethodFastTrackResistance(graph *G, mgp_graph *mg_graph, long *C, int nThreads, double Lower,
                                                double thresh, double *totTime, int *numItr, int phase, double *rmin,
                                                double *finMod);

// Define in parallelLouvianMethodNoMapFastTrackResistance.cpp
double parallelLouvianMethodNoMapFastTrackResistance(graph *G, long *C, int nThreads, double Lower, double thresh,
                                                     double *totTime, int *numItr, int phase, double *rmin,
                                                     double *finMod);
...
double parallelLouvianMethodScaleFastTrackResistance(graph *G, mgp_graph *mg_graph, long *C, int nThreads, double Lower,
                                                     double thresh, double *totTime, int *numItr, int phase,
                                                     double *rmin, double *finMod);
