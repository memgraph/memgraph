...
def parse_args():
    ...
    argp.add_argument("--benchmark-results-in-memory-analytical-path", type=str, required=True)
    argp.add_argument("--benchmark-results-on-disk-txn-path", type=str, required=True)
