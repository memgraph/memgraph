...
| T6 | Recompute combined DB totals | Make DB total reflect `storage + embeddings + query` | `DbMemoryUsage()` or equivalent combined reporting matches the intended hierarchy | Planned |
