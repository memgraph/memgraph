...
build_memgraph () {
  ...
  RM_COMMAND="rm -rf /opt/toolchain-${toolchain_version}/lib/python3.12 && rm -rf /opt/toolchain-${toolchain_version}/lib64/python3.12 && rm -rf /opt/toolchain-${toolchain_version}/include/python3.12"
