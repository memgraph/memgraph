...
print_help () {
  ...
  echo -e "  --no-ccache                   Disable ccache volume mounting (default \"$DEFAULT_CCACHE_ENABLED\") -> pass it to the run, stop and build-memgraph commands together, so the mount matches"
