...
MEMGRAPH_BUILD_DEPS=(
    ...
    mono-runtime mono-mcs zip unzip openjdk-25-jre-headless openjdk-25-jdk-headless custom-maven # for driver tests
    dotnet-sdk-10.0 golang custom-golang custom-node
