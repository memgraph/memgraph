...
#ifdef __cplusplus
extern "C" {
#define MGP_ENUM_CLASS_TAG enum class
#define MGP_ENUM_TAG enum
#else
#define MGP_ENUM_CLASS_TAG enum
#define MGP_ENUM_TAG enum
#endif
...
MGP_ENUM_CLASS_TAG MGP_NODISCARD mgp_error{MGP_ERROR_NO_ERROR,           MGP_ERROR_UNKNOWN_ERROR,
...
MGP_ENUM_TAG mgp_error mgp_alloc(struct mgp_memory *memory, size_t size_in_bytes, void **result);
...
/// The resulting pointer must be freed with mgp_free.
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to serve the requested allocation.
MGP_ENUM_TAG mgp_error mgp_aligned_alloc(struct mgp_memory *memory, size_t size_in_bytes, size_t alignment,
                                         void **result);
...
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to serve the requested allocation.
MGP_ENUM_TAG mgp_error mgp_global_alloc(size_t size_in_bytes, void **result);
...
/// The resulting pointer must be freed with mgp_global_free.
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to serve the requested allocation.
MGP_ENUM_TAG mgp_error mgp_global_aligned_alloc(size_t size_in_bytes, size_t alignment, void **result);
...
MGP_ENUM_TAG mgp_error mgp_value_make_null(struct mgp_memory *memory, struct mgp_value **result);

/// Construct a boolean value.
/// Non-zero values represent `true`, while zero represents `false`.
/// You need to free the instance through mgp_value_destroy.
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_value_make_bool(int val, struct mgp_memory *memory, struct mgp_value **result);

/// Construct an integer value.
/// You need to free the instance through mgp_value_destroy.
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_value_make_int(int64_t val, struct mgp_memory *memory, struct mgp_value **result);

/// Construct a double floating point value.
/// You need to free the instance through mgp_value_destroy.
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_value_make_double(double val, struct mgp_memory *memory, struct mgp_value **result);

/// Construct a character string value from a NULL terminated string.
/// You need to free the instance through mgp_value_destroy.
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_value_make_string(const char *val, struct mgp_memory *memory, struct mgp_value **result);
...
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_value_make_list(struct mgp_list *val, struct mgp_value **result);
...
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_value_make_map(struct mgp_map *val, struct mgp_value **result);
...
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_value_make_vertex(struct mgp_vertex *val, struct mgp_value **result);
...
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_value_make_edge(struct mgp_edge *val, struct mgp_value **result);
...
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_value_make_path(struct mgp_path *val, struct mgp_value **result);
...
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_value_make_date(struct mgp_date *val, struct mgp_value **result);
...
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_value_make_local_time(struct mgp_local_time *val, struct mgp_value **result);
...
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_value_make_local_date_time(struct mgp_local_date_time *val, struct mgp_value **result);
...
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_value_make_duration(struct mgp_duration *val, struct mgp_value **result);

/// Get the type of the value contained in mgp_value.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_type(struct mgp_value *val, enum mgp_value_type *result);

/// Result is non-zero if the given mgp_value represents `null`.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_null(struct mgp_value *val, int *result);

/// Result is non-zero if the given mgp_value stores a boolean.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_bool(struct mgp_value *val, int *result);

/// Result is non-zero if the given mgp_value stores an integer.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_int(struct mgp_value *val, int *result);

/// Result is non-zero if the given mgp_value stores a double floating-point.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_double(struct mgp_value *val, int *result);

/// Result is non-zero if the given mgp_value stores a character string.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_string(struct mgp_value *val, int *result);

/// Result is non-zero if the given mgp_value stores a list of values.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_list(struct mgp_value *val, int *result);

/// Result is non-zero if the given mgp_value stores a map of values.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_map(struct mgp_value *val, int *result);

/// Result is non-zero if the given mgp_value stores a vertex.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_vertex(struct mgp_value *val, int *result);

/// Result is non-zero if the given mgp_value stores an edge.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_edge(struct mgp_value *val, int *result);

/// Result is non-zero if the given mgp_value stores a path.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_path(struct mgp_value *val, int *result);

/// Result is non-zero if the given mgp_value stores a date.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_date(struct mgp_value *val, int *result);

/// Result is non-zero if the given mgp_value stores a local time.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_local_time(struct mgp_value *val, int *result);

/// Result is non-zero if the given mgp_value stores a local date-time.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_local_date_time(struct mgp_value *val, int *result);

/// Result is non-zero if the given mgp_value stores a duration.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_is_duration(struct mgp_value *val, int *result);

/// Get the contained boolean value.
/// Non-zero values represent `true`, while zero represents `false`.
/// Result is undefined if mgp_value does not contain the expected type.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_bool(struct mgp_value *val, int *result);

/// Get the contained integer.
/// Result is undefined if mgp_value does not contain the expected type.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_int(struct mgp_value *val, int64_t *result);

/// Get the contained double floating-point.
/// Result is undefined if mgp_value does not contain the expected type.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_double(struct mgp_value *val, double *result);

/// Get the contained character string.
/// Result is undefined if mgp_value does not contain the expected type.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_string(struct mgp_value *val, const char **result);

/// Get the contained list of values.
/// Result is undefined if mgp_value does not contain the expected type.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_list(struct mgp_value *val, struct mgp_list **result);

/// Get the contained map of values.
/// Result is undefined if mgp_value does not contain the expected type.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_map(struct mgp_value *val, struct mgp_map **result);

/// Get the contained vertex.
/// Result is undefined if mgp_value does not contain the expected type.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_vertex(struct mgp_value *val, struct mgp_vertex **result);

/// Get the contained edge.
/// Result is undefined if mgp_value does not contain the expected type.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_edge(struct mgp_value *val, struct mgp_edge **result);

/// Get the contained path.
/// Result is undefined if mgp_value does not contain the expected type.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_path(struct mgp_value *val, struct mgp_path **result);

/// Get the contained date.
/// Result is undefined if mgp_value does not contain the expected type.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_date(struct mgp_value *val, struct mgp_date **result);

/// Get the contained local time.
/// Result is undefined if mgp_value does not contain the expected type.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_local_time(struct mgp_value *val, struct mgp_local_time **result);

/// Get the contained local date-time.
/// Result is undefined if mgp_value does not contain the expected type.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_local_date_time(struct mgp_value *val, struct mgp_local_date_time **result);

/// Get the contained duration.
/// Result is undefined if mgp_value does not contain the expected type.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_value_get_duration(struct mgp_value *val, struct mgp_duration **result);
...
MGP_ENUM_TAG mgp_error mgp_list_make_empty(size_t capacity, struct mgp_memory *memory, struct mgp_list **result);
...
MGP_ENUM_TAG mgp_error mgp_list_append(struct mgp_list *list, struct mgp_value *val);
...
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_value.
MGP_ENUM_TAG mgp_error mgp_list_append_extend(struct mgp_list *list, struct mgp_value *val);

/// Get the number of elements stored in mgp_list.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_list_size(struct mgp_list *list, size_t *result);

/// Get the total number of elements for which there's already allocated
/// memory in mgp_list.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_list_capacity(struct mgp_list *list, size_t *result);
...
MGP_ENUM_TAG mgp_error mgp_list_at(struct mgp_list *list, size_t index, struct mgp_value **result);
...
MGP_ENUM_TAG mgp_error mgp_map_make_empty(struct mgp_memory *memory, struct mgp_map **result);
...
MGP_ENUM_TAG mgp_error mgp_map_insert(struct mgp_map *map, const char *key, struct mgp_value *value);

/// Get the number of items stored in mgp_map.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_map_size(struct mgp_map *map, size_t *result);

/// Get the mapped mgp_value to the given character string.
/// Result is NULL if no mapping exists.
MGP_ENUM_TAG mgp_error mgp_map_at(struct mgp_map *map, const char *key, struct mgp_value **result);

/// An item in the mgp_map.
struct mgp_map_item;

/// Get the key of the mapped item.
MGP_ENUM_TAG mgp_error mgp_map_item_key(struct mgp_map_item *item, const char **result);

/// Get the value of the mapped item.
MGP_ENUM_TAG mgp_error mgp_map_item_value(struct mgp_map_item *item, struct mgp_value **result);
...
MGP_ENUM_TAG mgp_error mgp_map_iter_items(struct mgp_map *map, struct mgp_memory *memory,
...
MGP_ENUM_TAG mgp_error mgp_map_items_iterator_get(struct mgp_map_items_iterator *it, struct mgp_map_item **result);
...
/// Result is NULL if the end of the iteration has been reached.
MGP_ENUM_TAG mgp_error mgp_map_items_iterator_next(struct mgp_map_items_iterator *it, struct mgp_map_item **result);
...
MGP_ENUM_TAG mgp_error mgp_path_make_with_start(struct mgp_vertex *vertex, struct mgp_memory *memory,
                                                struct mgp_path **result);

/// Copy a mgp_path.
/// Returned pointer must be freed with mgp_path_destroy.
/// mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE is returned if unable to allocate a mgp_path.
MGP_ENUM_TAG mgp_error mgp_path_copy(struct mgp_path *path, struct mgp_memory *memory, struct mgp_path **result);
...
MGP_ENUM_TAG mgp_error mgp_path_expand(struct mgp_path *path, struct mgp_edge *edge);

/// Get the number of edges in a mgp_path.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_path_size(struct mgp_path *path, size_t *result);
...
MGP_ENUM_TAG mgp_error mgp_path_vertex_at(struct mgp_path *path, size_t index, struct mgp_vertex **result);

/// Get the edge from a path at given index.
/// The valid index range is [0, mgp_path_size - 1].
/// mgp_error::MGP_ERROR_OUT_OF_RANGE is returned if index is out of range.
MGP_ENUM_TAG mgp_error mgp_path_edge_at(struct mgp_path *path, size_t index, struct mgp_edge **result);

/// Result is non-zero if given paths are equal, otherwise 0.
MGP_ENUM_TAG mgp_error mgp_path_equal(struct mgp_path *p1, struct mgp_path *p2, int *result);
...
MGP_ENUM_TAG mgp_error mgp_result_set_error_msg(struct mgp_result *res, const char *error_msg);
...
MGP_ENUM_TAG mgp_error mgp_result_new_record(struct mgp_result *res, struct mgp_result_record **result);
...
MGP_ENUM_TAG mgp_error mgp_result_record_insert(struct mgp_result_record *record, const char *field_name,
...
/// Result is NULL if the end of the iteration has been reached.
MGP_ENUM_TAG mgp_error mgp_properties_iterator_get(struct mgp_properties_iterator *it, struct mgp_property **result);
...
MGP_ENUM_TAG mgp_error mgp_properties_iterator_next(struct mgp_properties_iterator *it, struct mgp_property **result);
...
MGP_ENUM_TAG mgp_error mgp_vertex_get_id(struct mgp_vertex *v, struct mgp_vertex_id *result);
...
/// immutable also.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_vertex_underlying_graph_is_mutable(struct mgp_vertex *v, int *result);
...
MGP_ENUM_TAG mgp_error mgp_vertex_set_property(struct mgp_vertex *v, const char *property_name,
...
/// Return mgp_error::MGP_ERROR_DELETED_OBJECT if `v` has been deleted.
/// Return mgp_error::MGP_ERROR_SERIALIZATION_ERROR if `v` has been modified by another transaction.
MGP_ENUM_TAG mgp_error mgp_vertex_add_label(struct mgp_vertex *v, struct mgp_label label);
...
/// Return mgp_error::MGP_ERROR_DELETED_OBJECT if `v` has been deleted.
/// Return mgp_error::MGP_ERROR_SERIALIZATION_ERROR if `v` has been modified by another transaction.
MGP_ENUM_TAG mgp_error mgp_vertex_remove_label(struct mgp_vertex *v, struct mgp_label label);
...
MGP_ENUM_TAG mgp_error mgp_vertex_copy(struct mgp_vertex *v, struct mgp_memory *memory, struct mgp_vertex **result);
...
MGP_ENUM_TAG mgp_error mgp_vertex_equal(struct mgp_vertex *v1, struct mgp_vertex *v2, int *result);

/// Get the number of labels a given vertex has.
/// Return mgp_error::MGP_ERROR_DELETED_OBJECT if `v` has been deleted.
MGP_ENUM_TAG mgp_error mgp_vertex_labels_count(struct mgp_vertex *v, size_t *result);

/// Get mgp_label in mgp_vertex at given index.
/// Return mgp_error::MGP_ERROR_OUT_OF_RANGE if the index is out of range.
/// Return mgp_error::MGP_ERROR_DELETED_OBJECT if `v` has been deleted.
MGP_ENUM_TAG mgp_error mgp_vertex_label_at(struct mgp_vertex *v, size_t index, struct mgp_label *result);

/// Result is non-zero if the given vertex has the given label.
/// Return mgp_error::MGP_ERROR_DELETED_OBJECT if `v` has been deleted.
MGP_ENUM_TAG mgp_error mgp_vertex_has_label(struct mgp_vertex *v, struct mgp_label label, int *result);

/// Result is non-zero if the given vertex has a label with given name.
/// Return mgp_error::MGP_ERROR_DELETED_OBJECT if `v` has been deleted.
MGP_ENUM_TAG mgp_error mgp_vertex_has_label_named(struct mgp_vertex *v, const char *label_name, int *result);

/// Get a copy of a vertex property mapped to a given name.
/// Resulting value must be freed with mgp_value_destroy.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_value.
/// Return mgp_error::MGP_ERROR_DELETED_OBJECT if `v` has been deleted.
MGP_ENUM_TAG mgp_error mgp_vertex_get_property(struct mgp_vertex *v, const char *property_name,
...
/// Return mgp_error::MGP_ERROR_DELETED_OBJECT if `v` has been deleted.
MGP_ENUM_TAG mgp_error mgp_vertex_iter_properties(struct mgp_vertex *v, struct mgp_memory *memory,
...
/// Return mgp_error::MGP_ERROR_DELETED_OBJECT if `v` has been deleted.
MGP_ENUM_TAG mgp_error mgp_vertex_iter_in_edges(struct mgp_vertex *v, struct mgp_memory *memory,
...
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_edges_iterator.
/// Return mgp_error::MGP_ERROR_DELETED_OBJECT if `v` has been deleted.
MGP_ENUM_TAG mgp_error mgp_vertex_iter_out_edges(struct mgp_vertex *v, struct mgp_memory *memory,
                                                 struct mgp_edges_iterator **result);
...
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_edges_iterator_underlying_graph_is_mutable(struct mgp_edges_iterator *it, int *result);
...
/// Result is NULL if the end of the iteration has been reached.
MGP_ENUM_TAG mgp_error mgp_edges_iterator_get(struct mgp_edges_iterator *it, struct mgp_edge **result);
...
MGP_ENUM_TAG mgp_error mgp_edges_iterator_next(struct mgp_edges_iterator *it, struct mgp_edge **result);
...
MGP_ENUM_TAG mgp_error mgp_edge_get_id(struct mgp_edge *e, struct mgp_edge_id *result);
...
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_edge_underlying_graph_is_mutable(struct mgp_edge *e, int *result);

/// Copy a mgp_edge.
/// Resulting pointer must be freed with mgp_edge_destroy.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_edge.
MGP_ENUM_TAG mgp_error mgp_edge_copy(struct mgp_edge *e, struct mgp_memory *memory, struct mgp_edge **result);
...
MGP_ENUM_TAG mgp_error mgp_edge_equal(struct mgp_edge *e1, struct mgp_edge *e2, int *result);

/// Get the type of the given edge.
MGP_ENUM_TAG mgp_error mgp_edge_get_type(struct mgp_edge *e, struct mgp_edge_type *result);
...
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_edge_get_from(struct mgp_edge *e, struct mgp_vertex **result);

/// Get the destination vertex of the given edge.
/// Resulting vertex is valid until the edge is valid and it must not be used afterwards.
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_edge_get_to(struct mgp_edge *e, struct mgp_vertex **result);

/// Get a copy of a edge property mapped to a given name.
/// Resulting value must be freed with mgp_value_destroy.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_value.
/// Return mgp_error::MGP_ERROR_DELETED_OBJECT if `e` has been deleted.
MGP_ENUM_TAG mgp_error mgp_edge_get_property(struct mgp_edge *e, const char *property_name, struct mgp_memory *memory,
...
/// Return mgp_error::MGP_ERROR_VALUE_CONVERSION if `property_value` is vertex, edge or path.
MGP_ENUM_TAG mgp_error mgp_edge_set_property(struct mgp_edge *e, const char *property_name,
                                             struct mgp_value *property_value);
...
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_properties_iterator.
/// Return mgp_error::MGP_ERROR_DELETED_OBJECT if `e` has been deleted.
MGP_ENUM_TAG mgp_error mgp_edge_iter_properties(struct mgp_edge *e, struct mgp_memory *memory,
                                                struct mgp_properties_iterator **result);
...
MGP_ENUM_TAG mgp_error mgp_graph_get_vertex_by_id(struct mgp_graph *g, struct mgp_vertex_id id,
...
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_graph_is_mutable(struct mgp_graph *graph, int *result);

/// Add a new vertex to the graph.
/// Resulting vertex must be freed using mgp_vertex_destroy.
/// Return mgp_error::MGP_ERROR_IMMUTABLE_OBJECT if `graph` is immutable.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_vertex.
MGP_ENUM_TAG mgp_error mgp_graph_create_vertex(struct mgp_graph *graph, struct mgp_memory *memory,
...
MGP_ENUM_TAG mgp_error mgp_graph_delete_vertex(struct mgp_graph *graph, struct mgp_vertex *vertex);

/// Delete a vertex and all of its edges from the graph.
/// Return mgp_error::MGP_ERROR_IMMUTABLE_OBJECT if `graph` is immutable.
/// Return mgp_error::MGP_ERROR_SERIALIZATION_ERROR if `vertex` has been modified by another transaction.
MGP_ENUM_TAG mgp_error mgp_graph_detach_delete_vertex(struct mgp_graph *graph, struct mgp_vertex *vertex);
...
MGP_ENUM_TAG mgp_error mgp_graph_create_edge(struct mgp_graph *graph, struct mgp_vertex *from, struct mgp_vertex *to,
...
/// another transaction.
MGP_ENUM_TAG mgp_error mgp_graph_delete_edge(struct mgp_graph *graph, struct mgp_edge *edge);
...
MGP_ENUM_TAG mgp_error mgp_graph_iter_vertices(struct mgp_graph *g, struct mgp_memory *memory,
...
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_vertices_iterator_underlying_graph_is_mutable(struct mgp_vertices_iterator *it, int *result);
...
/// Result is NULL if the end of the iteration has been reached.
MGP_ENUM_TAG mgp_error mgp_vertices_iterator_get(struct mgp_vertices_iterator *it, struct mgp_vertex **result);
...
MGP_ENUM_TAG mgp_error mgp_date_from_string(const char *string, struct mgp_memory *memory, struct mgp_date **date);
...
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_date.
MGP_ENUM_TAG mgp_error mgp_date_from_parameters(struct mgp_date_parameters *parameters, struct mgp_memory *memory,
                                                struct mgp_date **date);

/// Copy a mgp_date.
/// Resulting pointer must be freed with mgp_date_destroy.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_date.
MGP_ENUM_TAG mgp_error mgp_date_copy(struct mgp_date *date, struct mgp_memory *memory, struct mgp_date **result);
...
MGP_ENUM_TAG mgp_error mgp_date_equal(struct mgp_date *first, struct mgp_date *second, int *result);

/// Get the year property of the date.
MGP_ENUM_TAG mgp_error mgp_date_get_year(struct mgp_date *date, int *year);

/// Get the month property of the date.
MGP_ENUM_TAG mgp_error mgp_date_get_month(struct mgp_date *date, int *month);

/// Get the day property of the date.
MGP_ENUM_TAG mgp_error mgp_date_get_day(struct mgp_date *date, int *day);

/// Get the date as microseconds from Unix epoch.
MGP_ENUM_TAG mgp_error mgp_date_timestamp(struct mgp_date *date, int64_t *timestamp);

/// Get the date representing current date.
/// Resulting date must be freed with mgp_date_destroy.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_date.
MGP_ENUM_TAG mgp_error mgp_date_now(struct mgp_memory *memory, struct mgp_date **date);

/// Add a duration to the date.
/// Resulting date must be freed with mgp_date_destroy.
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the operation results in an invalid date.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_date.
MGP_ENUM_TAG mgp_error mgp_date_add_duration(struct mgp_date *date, struct mgp_duration *dur, struct mgp_memory *memory,
...
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the operation results in an invalid date.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_date.
MGP_ENUM_TAG mgp_error mgp_date_sub_duration(struct mgp_date *date, struct mgp_duration *dur, struct mgp_memory *memory,
                                             struct mgp_date **result);

/// Get a duration between two dates.
/// Resulting duration must be freed with mgp_duration_destroy.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_date.
MGP_ENUM_TAG mgp_error mgp_date_diff(struct mgp_date *first, struct mgp_date *second, struct mgp_memory *memory,
...
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the string cannot be parsed correctly.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_date.
MGP_ENUM_TAG mgp_error mgp_local_time_from_string(const char *string, struct mgp_memory *memory,
...
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the parameters cannot be parsed correctly.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_date.
MGP_ENUM_TAG mgp_error mgp_local_time_from_parameters(struct mgp_local_time_parameters *parameters,
...
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_date.
MGP_ENUM_TAG mgp_error mgp_local_time_copy(struct mgp_local_time *local_time, struct mgp_memory *memory,
...
MGP_ENUM_TAG mgp_error mgp_local_time_equal(struct mgp_local_time *first, struct mgp_local_time *second, int *result);

/// Get the hour property of the local time.
MGP_ENUM_TAG mgp_error mgp_local_time_get_hour(struct mgp_local_time *local_time, int *hour);

/// Get the minute property of the local time.
MGP_ENUM_TAG mgp_error mgp_local_time_get_minute(struct mgp_local_time *local_time, int *minute);

/// Get the second property of the local time.
MGP_ENUM_TAG mgp_error mgp_local_time_get_second(struct mgp_local_time *local_time, int *second);

/// Get the millisecond property of the local time.
MGP_ENUM_TAG mgp_error mgp_local_time_get_millisecond(struct mgp_local_time *local_time, int *millisecond);

/// Get the microsecond property of the local time.
MGP_ENUM_TAG mgp_error mgp_local_time_get_microsecond(struct mgp_local_time *local_time, int *microsecond);

/// Get the local time as microseconds from midnight.
MGP_ENUM_TAG mgp_error mgp_local_time_timestamp(struct mgp_local_time *local_time, int64_t *timestamp);

/// Get the local time representing current time.
/// Resulting pointer must be freed with mgp_local_time_destroy.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_date.
MGP_ENUM_TAG mgp_error mgp_local_time_now(struct mgp_memory *memory, struct mgp_local_time **local_time);
...
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_date.
MGP_ENUM_TAG mgp_error mgp_local_time_add_duration(struct mgp_local_time *local_time, struct mgp_duration *dur,
...
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the operation results in an invalid local time.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_date.
MGP_ENUM_TAG mgp_error mgp_local_time_sub_duration(struct mgp_local_time *local_time, struct mgp_duration *dur,
                                                   struct mgp_memory *memory, struct mgp_local_time **result);

/// Get a duration between two local times.
/// Resulting pointer must be freed with mgp_duration_destroy.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_date.
MGP_ENUM_TAG mgp_error mgp_local_time_diff(struct mgp_local_time *first, struct mgp_local_time *second,
...
MGP_ENUM_TAG mgp_error mgp_local_date_time_from_string(const char *string, struct mgp_memory *memory,
...
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the parameters cannot be parsed correctly.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_local_date_time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_from_parameters(struct mgp_local_date_time_parameters *parameters,
...
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_local_date_time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_copy(struct mgp_local_date_time *local_date_time, struct mgp_memory *memory,
...
MGP_ENUM_TAG mgp_error mgp_local_date_time_equal(struct mgp_local_date_time *first, struct mgp_local_date_time *second,
                                                 int *result);

/// Get the year property of the local date-time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_get_year(struct mgp_local_date_time *local_date_time, int *year);

/// Get the month property of the local date-time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_get_month(struct mgp_local_date_time *local_date_time, int *month);

/// Get the day property of the local date-time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_get_day(struct mgp_local_date_time *local_date_time, int *day);

/// Get the hour property of the local date-time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_get_hour(struct mgp_local_date_time *local_date_time, int *hour);

/// Get the minute property of the local date-time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_get_minute(struct mgp_local_date_time *local_date_time, int *minute);

/// Get the second property of the local date-time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_get_second(struct mgp_local_date_time *local_date_time, int *second);

/// Get the milisecond property of the local date-time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_get_millisecond(struct mgp_local_date_time *local_date_time,
                                                           int *millisecond);

/// Get the microsecond property of the local date-time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_get_microsecond(struct mgp_local_date_time *local_date_time,
                                                           int *microsecond);

/// Get the local date-time as microseconds from Unix epoch.
MGP_ENUM_TAG mgp_error mgp_local_date_time_timestamp(struct mgp_local_date_time *local_date_time, int64_t *timestamp);

/// Get the local date-time representing current date and time.
/// Resulting local date-time must be freed with mgp_local_date_time_destroy.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_local_date_time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_now(struct mgp_memory *memory, struct mgp_local_date_time **local_date_time);
...
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_local_date_time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_add_duration(struct mgp_local_date_time *local_date_time,
                                                        struct mgp_duration *dur, struct mgp_memory *memory,
                                                        struct mgp_local_date_time **result);
...
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the operation results in an invalid local date-time.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_local_date_time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_sub_duration(struct mgp_local_date_time *local_date_time,
                                                        struct mgp_duration *dur, struct mgp_memory *memory,
                                                        struct mgp_local_date_time **result);
...
/// Resulting duration must be freed with mgp_duration_destroy.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_local_date_time.
MGP_ENUM_TAG mgp_error mgp_local_date_time_diff(struct mgp_local_date_time *first, struct mgp_local_date_time *second,
                                                struct mgp_memory *memory, struct mgp_duration **result);
...
MGP_ENUM_TAG mgp_error mgp_duration_from_string(const char *string, struct mgp_memory *memory,
...
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the parameters cannot be parsed correctly.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_duration.
MGP_ENUM_TAG mgp_error mgp_duration_from_parameters(struct mgp_duration_parameters *parameters,
                                                    struct mgp_memory *memory, struct mgp_duration **duration);

/// Create a duration from microseconds.
/// Resulting duration must be freed with mgp_duration_destroy.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_duration.
MGP_ENUM_TAG mgp_error mgp_duration_from_microseconds(int64_t microseconds, struct mgp_memory *memory,
                                                      struct mgp_duration **duration);

/// Copy a mgp_duration.
/// Resulting pointer must be freed with mgp_duration_destroy.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_duration.
MGP_ENUM_TAG mgp_error mgp_duration_copy(struct mgp_duration *duration, struct mgp_memory *memory,
                                         struct mgp_duration **result);
...
MGP_ENUM_TAG mgp_error mgp_duration_equal(struct mgp_duration *first, struct mgp_duration *second, int *result);

/// Get the duration as microseconds.
MGP_ENUM_TAG mgp_error mgp_duration_get_microseconds(struct mgp_duration *duration, int64_t *microseconds);

/// Apply unary minus operator to the duration.
/// Resulting pointer must be freed with mgp_duration_destroy.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_duration.
MGP_ENUM_TAG mgp_error mgp_duration_neg(struct mgp_duration *dur, struct mgp_memory *memory,
                                        struct mgp_duration **result);
...
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_duration.
MGP_ENUM_TAG mgp_error mgp_duration_add(struct mgp_duration *first, struct mgp_duration *second,
                                        struct mgp_memory *memory, struct mgp_duration **result);
...
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the operation results in an invalid duration.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_duration.
MGP_ENUM_TAG mgp_error mgp_duration_sub(struct mgp_duration *first, struct mgp_duration *second,
                                        struct mgp_memory *memory, struct mgp_duration **result);
///@}
...
/// Result is NULL if the end of the iteration has been reached.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate a mgp_vertex.
MGP_ENUM_TAG mgp_error mgp_vertices_iterator_next(struct mgp_vertices_iterator *it, struct mgp_vertex **result);
///@}
...
MGP_ENUM_TAG mgp_error mgp_type_any(struct mgp_type **result);

/// Get the type representing boolean values.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_bool(struct mgp_type **result);

/// Get the type representing character string values.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_string(struct mgp_type **result);

/// Get the type representing integer values.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_int(struct mgp_type **result);

/// Get the type representing floating-point values.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_float(struct mgp_type **result);

/// Get the type representing any number value.
///
/// This is the parent type for numeric types, i.e. INTEGER and FLOAT.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_number(struct mgp_type **result);
...
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_map(struct mgp_type **result);
...
/// type.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_node(struct mgp_type **result);
...
/// is also of MAP type.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_relationship(struct mgp_type **result);

/// Get the type representing a graph path (walk) from one node to another.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_path(struct mgp_type **result);

/// Build a type representing a list of values of given `element_type`.
///
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_list(struct mgp_type *element_type, struct mgp_type **result);

/// Get the type representing a date.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_date(struct mgp_type **result);

/// Get the type representing a local time.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_local_time(struct mgp_type **result);

/// Get the type representing a local date-time.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_local_date_time(struct mgp_type **result);

/// Get the type representing a duration.
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_duration(struct mgp_type **result);

/// Build a type representing either a `null` value or a value of given `type`.
///
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate the new type.
MGP_ENUM_TAG mgp_error mgp_type_nullable(struct mgp_type *type, struct mgp_type **result);
///@}
...
MGP_ENUM_TAG mgp_error mgp_module_add_read_procedure(struct mgp_module *module, const char *name, mgp_proc_cb cb,
...
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if `name` is not a valid procedure name.
/// RETURN mgp_error::MGP_ERROR_LOGIC_ERROR if a procedure with the same name was already registered.
MGP_ENUM_TAG mgp_error mgp_module_add_write_procedure(struct mgp_module *module, const char *name, mgp_proc_cb cb,
                                                      struct mgp_proc **result);
...
MGP_ENUM_TAG mgp_error mgp_proc_add_arg(struct mgp_proc *proc, const char *name, struct mgp_type *type);
...
MGP_ENUM_TAG mgp_error mgp_proc_add_opt_arg(struct mgp_proc *proc, const char *name, struct mgp_type *type,
...
MGP_ENUM_TAG mgp_error mgp_proc_add_result(struct mgp_proc *proc, const char *name, struct mgp_type *type);
...
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if `name` is not a valid result name.
/// RETURN mgp_error::MGP_ERROR_LOGIC_ERROR if a result field with the same name was already added.
MGP_ENUM_TAG mgp_error mgp_proc_add_deprecated_result(struct mgp_proc *proc, const char *name, struct mgp_type *type);
///@}
...
MGP_ENUM_TAG mgp_error mgp_message_source_type(struct mgp_message *message, enum mgp_source_type *result);
...
MGP_ENUM_TAG mgp_error mgp_message_payload(struct mgp_message *message, const char **result);
...
///   - Pulsar
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the message is from an unsupported stream source.
MGP_ENUM_TAG mgp_error mgp_message_payload_size(struct mgp_message *message, size_t *result);
...
///   - Pulsar
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the message is from an unsupported stream source.
MGP_ENUM_TAG mgp_error mgp_message_topic_name(struct mgp_message *message, const char **result);

/// Get the key of mgp_message as a byte array
/// Supported stream sources:
///   - Kafka
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the message is from an unsupported stream source.
MGP_ENUM_TAG mgp_error mgp_message_key(struct mgp_message *message, const char **result);

/// Get the key size of mgp_message
/// Supported stream sources:
///   - Kafka
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the message is from an unsupported stream source.
MGP_ENUM_TAG mgp_error mgp_message_key_size(struct mgp_message *message, size_t *result);

/// Get the timestamp of mgp_message as a byte array
/// Supported stream sources:
///   - Kafka
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the message is from an unsupported stream source.
MGP_ENUM_TAG mgp_error mgp_message_timestamp(struct mgp_message *message, int64_t *result);

/// Get the message offset from a message.
/// Supported stream sources:
///   - Kafka
/// Return mgp_error::MGP_ERROR_INVALID_ARGUMENT if the message is from an unsupported stream source.
MGP_ENUM_TAG mgp_error mgp_message_offset(struct mgp_message *message, int64_t *result);

/// Get the number of messages contained in the mgp_messages list
/// Current implementation always returns without errors.
MGP_ENUM_TAG mgp_error mgp_messages_size(struct mgp_messages *message, size_t *result);

/// Get the message from a messages list at given index
MGP_ENUM_TAG mgp_error mgp_messages_at(struct mgp_messages *message, size_t index, struct mgp_message **result);
...
MGP_ENUM_TAG mgp_error mgp_module_add_transformation(struct mgp_module *module, const char *name, mgp_trans_cb cb);
/// @}
...
MGP_ENUM_TAG mgp_error mgp_func_add_arg(struct mgp_func *func, const char *name, struct mgp_type *type);
...
/// Return mgp_error::MGP_ERROR_VALUE_CONVERSION if `default_value` is a graph element (vertex, edge or path).
/// Return mgp_error::MGP_ERROR_LOGIC_ERROR if `default_value` does not satisfy `type`.
MGP_ENUM_TAG mgp_error mgp_func_add_opt_arg(struct mgp_func *func, const char *name, struct mgp_type *type,
                                            struct mgp_value *default_value);
...
MGP_ENUM_TAG mgp_error mgp_module_add_function(struct mgp_module *module, const char *name, mgp_func_cb cb,
...
MGP_ENUM_TAG mgp_error mgp_func_result_set_error_msg(struct mgp_func_result *result, const char *error_msg,
                                                     struct mgp_memory *memory);

/// Set an output value for the Magic function
/// Return mgp_error::MGP_ERROR_UNABLE_TO_ALLOCATE if unable to allocate memory to copy the mgp_value to
/// mgp_func_result.
MGP_ENUM_TAG mgp_error mgp_func_result_set_value(struct mgp_func_result *result, struct mgp_value *value,
                                                 struct mgp_memory *memory);
/// @}
